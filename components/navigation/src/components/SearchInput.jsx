...
function SearchInput({
	...
	const searchLandingRef = createRef();
	...
	const showOverlay =
		isFocused &&
		((!isSearchLandingEmpty && searchInput.length === 0) ||
	...
	useOnClickOutside([inputRef, dropdownRef, searchLandingRef], closeMenu);
