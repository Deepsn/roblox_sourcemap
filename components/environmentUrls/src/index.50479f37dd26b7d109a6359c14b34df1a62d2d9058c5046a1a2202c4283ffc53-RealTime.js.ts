...
const { production, domainName, rootDomain } = getDomainInfo(
...
const environmentUrls = {
	...
	assetPathPrefix: `https://assets.create.${rootDomain}`,
	...
	apiGatewayCdnUrl: production
		? "https://apis.rbxcdn.com"
		: `https://apis.${rootDomain}`,
	eduAuthenticationApi: production
		? "https://auth.rblx.org"
		: `https://auth.${domainName}.rblx.org`,
	eduWebsiteUrl: production
		? "https://www.rblx.org"
		: `https://www.${domainName}.rblx.org`,
	...
	windowsStoreLink:
		"https://www.microsoft.com/en-us/store/games/roblox/9nblgggzm6wm",
