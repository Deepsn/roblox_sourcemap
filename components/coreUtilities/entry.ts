	...
	setClientInterceptors({
		...
		gcs: AsyncResult.fn(async (url, options, error, next) => {
			if (error instanceof HttpError) {
				...
				const challengeTypeRaw = responseHeaders.get(
					genericChallengeTypeHeader,
				);
...
addExternal(
	["Roblox", "core-scripts", "util", "currentBrowser"],
	currentBrowser,
);
addExternal(
	["Roblox", "core-scripts", "util", "cursorPagination"],
	cursorPagination,
);
...
addExternal(
	["Roblox", "core-scripts", "auth", "hybridResponse"],
	hybridResponse,
);
...
addExternal(
	["Roblox", "core-scripts", "localStorage", "localStorage"],
	localStorageService,
);
addExternal(
	["Roblox", "core-scripts", "localStorage", "keys"],
	localStorageKeys,
);
