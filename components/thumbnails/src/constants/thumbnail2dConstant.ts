...
import type { BatchRequestProcessor } from "@rbx/core-scripts/util/batch-request";
...
export type ThumbnailRequesters<QueueItem, QueueItemData> = Record<
	string,
	BatchRequestProcessor<QueueItem, QueueItemData>
>;

export type ThumbnailCache = Record<string, object>;
...
export type ThumbnailPendingTracker = Record<
	string,
	ThumbnailPendingTrackerItem
>;

export type ThumbnailCompleteTracker = Record<
	string,
	ThumbnailCompleteTrackerItem
>;
