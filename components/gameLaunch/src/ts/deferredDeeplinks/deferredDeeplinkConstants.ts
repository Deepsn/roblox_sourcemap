...
const deferredDeeplinkWindowsLayerName =
	"ExperienceDetailsPage.Windows.ClientDownload";
...
const supportedDeferredDeeplinkPathPatterns =
	supportedDeferredDeeplinkPaths.map(
