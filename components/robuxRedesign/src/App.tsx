...
const persistPaymentSessionToLocalStorage = (
...
export const App = (buyRobuxPageData: BuyRobuxPageData) => {
	...
	const { bonusItemBannerImageUrl, bonusItemImageUrl, giftingAvatarImageUrl } =
		useThumbnails({
			bonusItemId,
			bonusItemRootPlaceId,
			giftingUrl,
	...
	return (
		<BuyRobuxPageContext.Provider value={buyRobuxPageContextValue}>
          ...
          at all times so challenges can render */}
			<div
				id="generic-challenge-container"
				data-testid="generic-challenge-container"
			/>
			<TrackingContainer>
				<PurchasingContainer>
					<BuyRobuxPage />
