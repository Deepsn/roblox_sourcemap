...
export type ProcessPaymentPaypalProviderPayload =
	ProcessPaymentBaseProviderPayload & {
		RedirectionUrl?: string; // PayPal uses this field
	};

export type ProcessPaymentStripeProviderPayload =
	ProcessPaymentBaseProviderPayload & {
...
export const getPaymentProfiles = async (): Promise<
	GetPaymentProfilesResponse | undefined
> =>
	withApiEvents<GetPaymentProfilesResponse>(
		HTTPVerb.GET,
		APICall.GET_PAYMENT_PROFILES,
		{
