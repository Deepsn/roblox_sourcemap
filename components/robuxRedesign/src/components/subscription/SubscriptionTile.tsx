...
function convertPeriodTypeForTranslation(
...
export const SubscriptionTile: FC<SubscriptionTileProps> = ({
	...
	const apiProductType =
		SECTION_PRODUCT_TYPE_TO_API[product.subscriptionProductType];
	...
	return (
		...
		>
			<div className="flex flex-row items-center justify-between gap-large">
				<h3 className="text-label-large content-emphasis text-truncate-end">
					{title}
				</h3>
				<div className="flex flex-row items-center justify-end gap-small">
					...
					<span className="text-title-medium content-emphasis text-no-wrap">
						{price}
					</span>
				</div>
			</div>

			<SubscriptionTileBenefits
				product={product}
				robuxAllowance={robuxAllowance}
			/>
