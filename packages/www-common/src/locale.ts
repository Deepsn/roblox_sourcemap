 ...
 * Missing translations for these locales fall back to another locale based off {@link fallbackLocales}.
 */
export type PartiallySupportedLocale =
	(typeof partiallySupportedLocales)[number];
...
export const defaultLocaleLowercaseDash =
	"en-us" as const satisfies LocaleLowercaseDash;
export const defaultLocaleUppercaseDash =
	"en-US" as const satisfies LocaleUppercaseDash;
...
type LengthMatches<A, B> = A extends { readonly length: infer L1 }
	? B extends { readonly length: L1 }
		...
		: never
	: never;
const _1: LengthMatches<
	typeof fullySupportedLocales,
	typeof fullySupportedLocalesLowercaseDash
> = true;
...
> = true;
const _6: LengthMatches<typeof locales, typeof localesLowercaseUnderscore> =
	true;

const _7: LengthMatches<typeof locales, typeof localesUppercaseDash> = true;
const _8: LengthMatches<
	typeof fullySupportedLocales,
	typeof fullySupportedLocalesUppercaseDash
> = true;
...
export type FullySupportedLocaleLowercaseDash =
	(typeof fullySupportedLocalesLowercaseDash)[number];
...
export type LocaleLowercaseUnderscore =
	(typeof localesLowercaseUnderscore)[number];
...
export type FullySupportedLocaleUppercaseDash =
	(typeof fullySupportedLocalesUppercaseDash)[number];
...
export const localeToLowercaseDash = (locale: Locale): LocaleLowercaseDash =>
	locale;

export const localeToLowercaseUnderscore = (
	locale: Locale,
): LocaleLowercaseUnderscore =>
...
export const localeFromLowercaseDash = (locale: LocaleLowercaseDash): Locale =>
	locale;

export const localeFromLowercaseUnderscore = (
	locale: LocaleLowercaseUnderscore,
): Locale =>
	// eslint-disable-next-line @typescript-eslint/no-unsafe-type-assertion
 ...
 */
export const urlLanguageOrLocalePrefixes = [
	...urlLanguagePrefixes,
	...urlLocalePrefixes,
] as const;
 ...
 */
export type UrlLanguageOrLocalePrefix =
	(typeof urlLanguageOrLocalePrefixes)[number];
...
export const stripLocalePrefix = (pathname: string): string => {
	...
	const firstSegment =
		separatorIndex === -1
			...
			: pathname.substring(1, separatorIndex);
	...
	const hasLocalePrefix = arrayIncludes(
		urlLanguagePrefixes,
