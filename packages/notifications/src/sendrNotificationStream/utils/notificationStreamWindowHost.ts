...
export type NotificationStreamAbuseReportHost = (
...
let notificationStreamMetaActionsHost: NotificationStreamMetaActionsHost | null =
	null;
let notificationStreamTrustedFriendsHost: NotificationStreamTrustedFriendsHost | null =
	null;
let notificationStreamAbuseReportHost: NotificationStreamAbuseReportHost | null =
	null;

const metaActionsWindowHandler = (event: Event): void => {
	// eslint-disable-next-line @typescript-eslint/no-unsafe-type-assertion
	notificationStreamMetaActionsHost?.(
		event as CustomEvent<SelectedNotificationState>,
	);
};
...
const trustedFriendsWindowHandler = (event: Event): void => {
	// eslint-disable-next-line @typescript-eslint/no-unsafe-type-assertion
	const { detail } =
		event as CustomEvent<TrustedFriendsAcceptModalRequestDetail>;
...
export function openNotificationStreamAbuseReport(
	notificationData: NotificationData,
): void {
