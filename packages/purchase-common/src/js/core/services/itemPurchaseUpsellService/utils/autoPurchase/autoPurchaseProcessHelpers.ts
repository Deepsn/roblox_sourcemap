...
async function validateAndGetDataObject(
	...
	const itemDetailData = {
		...
		collectibleItemId:
			cookieData.collectibleItemId ||
			itemDetailDataElementMap?.collectibleItemId,
		collectibleItemInstanceId:
			cookieData.collectibleItemInstanceId ||
			itemDetailDataElementMap?.collectibleItemInstanceId,
		collectibleProductId:
			cookieData.collectibleProductId ||
			itemDetailDataElementMap?.collectibleProductId,
	} as ItemDetailElementDataset;
