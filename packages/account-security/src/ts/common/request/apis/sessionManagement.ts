...
export const getSessions = async (
	...
	Result<
		SessionManagement.GetSessionsReturnType,
		SessionManagement.SessionManagementError | null
	>
> =>
	toResult(
		httpService.get(SessionManagement.GET_SESSIONS_CONFIG, {
			nextCursor,
			desiredLimit,
		}),
...
export const logoutSession = async (
	...
	Result<
		SessionManagement.LogoutSessionReturnType,
		SessionManagement.SessionManagementError | null
	>
> =>
	toResult(
...
export const logoutFromAllSessionsAndReauthenticate = async (
	...
	Result<
		SessionManagement.LogoutFromAllSessionsReturnType,
		SessionManagement.AuthError | null
	>
> =>
	toResult(
