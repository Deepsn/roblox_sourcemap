...
export const getUserById = (
	...
	toResult(http.get(Users.GET_USER_BY_ID_CONFIG(userId)), Users.UsersApiError);

export const getUserByUsername = (
	username: string,
): Promise<Result<Users.UserInfoListResponse, Users.UsersApiError | null>> =>
	toResult(
		http.post(Users.GET_USER_BY_USERNAME_CONFIG, {
			usernames: [username],
...
export const getUsersByIds = (
	...
	toResult(
		http.post(Users.GET_USERS_BY_IDS_CONFIG, {
			userIds,
