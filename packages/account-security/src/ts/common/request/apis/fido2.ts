...
export const getNativeResponse = (
	...
	Result<fido2.GetNativeResponseReturnType, fido2.Fido2Error | null>
> =>
...
export const getNavigatorCredentials = (
	...
	Result<fido2.GetNavigatorCredentialsReturnType, fido2.Fido2Error | null>
> =>
	toResultCustomRequest(
		...
		Result.map(result, (credential: Credential | null) => {
			...
			return fido2Util.formatCredentialAuthenticationResponseWeb(
