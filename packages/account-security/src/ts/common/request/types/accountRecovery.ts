...
export type RecoveryIntentStatus =
	(typeof RecoveryIntentStatus)[keyof typeof RecoveryIntentStatus];
...
export type VerifyRecoveryIntentReturnType = {
	status:
		| typeof RecoveryIntentStatus.Pending
		| typeof RecoveryIntentStatus.Redeemed;
};
