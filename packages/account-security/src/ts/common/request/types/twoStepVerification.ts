 ...
 * Request Type: `POST`.
 */
export const ENABLE_EMAIL_TWO_STEP_VERIFICATION_CONFIG: (
	userId: string,
) => UrlConfig = (userId) => ({
	withCredentials: true,
 ...
 * Request Type: `POST`.
 */
export const ENABLE_AUTHENTICATOR_CONFIG: (userId: string) => UrlConfig = (
	userId,
) => ({
	withCredentials: true,
 ...
 * Request Type: `POST`.
 */
export const ENABLE_VERIFY_AUTHENTICATOR_CONFIG: (userId: string) => UrlConfig =
	(userId) => ({
		withCredentials: true,
 ...
 * Request Type: `POST`.
 */
export const DISABLE_AUTHENTICATOR_CONFIG: (userId: string) => UrlConfig = (
	userId,
) => ({
	withCredentials: true,
 ...
 * Request Type: `GET`.
 */
export const GET_RECOVERY_CODES_STATUS_CONFIG: (userId: string) => UrlConfig = (
	userId,
) => ({
	withCredentials: true,
 ...
 * Request Type: `POST`.
 */
export const CLEAR_RECOVERY_CODES_CONFIG: (userId: string) => UrlConfig = (
	userId,
) => ({
	withCredentials: true,
 ...
 * Request Type: `GET`.
 */
export const GENERATE_RECOVERY_CODES_CONFIG: (userId: string) => UrlConfig = (
	userId,
) => ({
	withCredentials: true,
 ...
 * Request Type: `POST`.
 */
export const ENABLE_SMS_TWO_STEP_VERIFICATION_CONFIG: (
	userId: string,
) => UrlConfig = (userId) => ({
	withCredentials: true,
 ...
 * Request Type: `POST`.
 */
export const DISABLE_SMS_TWO_STEP_VERIFICATION_CONFIG: (
	userId: string,
) => UrlConfig = (userId) => ({
	withCredentials: true,
 ...
 * Request Type: `POST`.
 */
export const ENABLE_SECURITY_KEY_CONFIG: (userId: string) => UrlConfig = (
	userId,
) => ({
	withCredentials: true,
 ...
 * Request Type: `POST`.
 */
export const ENABLE_VERIFY_SECURITY_KEY_CONFIG: (userId: string) => UrlConfig =
	(userId) => ({
		withCredentials: true,
 ...
 * Request Type: `POST`.
 */
export const DELETE_SECURITY_KEY_CONFIG: (userId: string) => UrlConfig = (
	userId,
) => ({
	withCredentials: true,
 ...
 * Request Type: `POST`.
 */
export const RENAME_SECURITY_KEY_CONFIG: (userId: string) => UrlConfig = (
	userId,
) => ({
	withCredentials: true,
 ...
 * Request Type: `POST`.
 */
export const LIST_SECURITY_KEY_CONFIG: (userId: string) => UrlConfig = (
	userId,
) => ({
	withCredentials: true,
 ...
 * Request Type: `GET`.
 */
export const GET_PASSKEY_OPTIONS_CONFIG: (userId: string) => UrlConfig = (
	userId,
) => ({
	withCredentials: true,
 ...
 * Request Type: `POST`.
 */
export const VERIFY_PASSKEY_CREDENTIAL_CONFIG: (userId: string) => UrlConfig = (
	userId,
) => ({
	withCredentials: true,
 ...
 * Request Type: `POST`.
 */
export const RETRY_CROSS_DEVICE_PROMPT_CONFIG: (userId: string) => UrlConfig = (
	userId,
) => ({
	withCredentials: true,
 ...
 * Request Type: `POST`.
 */
export const VERIFY_CROSS_DEVICE_PROMPT_CONFIG: (userId: string) => UrlConfig =
	(userId) => ({
		withCredentials: true,
 ...
 * Request Type: `POST`.
 */
export const RETRACT_CROSS_DEVICE_PROMPT_CONFIG: (userId: string) => UrlConfig =
	(userId) => ({
		withCredentials: true,
 ...
 * Request Type: `POST`.
 */
export const VERIFY_PASSWORD_CONFIG: (userId: string) => UrlConfig = (
	userId,
) => ({
	withCredentials: true,
