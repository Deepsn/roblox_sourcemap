...
import { ForceActionRedirectContext } from "../store/contextProvider";
 ...
 */
const useForceActionRedirectContext: () => ForceActionRedirectContext = () => {
	const context = useContext(ForceActionRedirectContext);
	if (context === null) {
		throw new Error(
...
export default useForceActionRedirectContext;
