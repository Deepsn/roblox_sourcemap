...
const ForceAuthenticatorValidator = z
	.object({})
	.and(SharedChallengeMetadataValidator);

const ForceTwoStepVerificationValidator = z
	.object({})
	.and(SharedChallengeMetadataValidator);
...
const CaptchaV2Validator = z
	.object({
		...
		// eslint-disable-next-line @typescript-eslint/no-unsafe-type-assertion
		mode: z.string().optional() as unknown as z.ZodType<
...
export const ChallengeMetadataValidator: {
	...
	[ChallengeType.FORCE_TWO_STEP_VERIFICATION]:
		ForceTwoStepVerificationValidator,
