...
export const trustedFriendStatusQueryKey = (
	userId: number,
): readonly [string, number] => ["trustedFriendStatus", userId];

export const trustedFriendVpcAmpQueryKey = (
	userId: number,
): readonly [string, number] => ["trustedFriendVpcAmp", userId];
