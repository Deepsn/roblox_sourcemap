...
const translationAnalyticsApiInstance =
	new GameInternationalizationProvider.TranslationAnalyticsApi();

const getMetadata =
	(): AxiosPromise<GameInternationalizationProvider.RobloxGameInternationalizationApiTranslationAnalyticsMetadataResponse> =>
		translationAnalyticsApiInstance.v1TranslationAnalyticsMetadataGet({
...
const downloadReport = (
	...
	translationAnalyticsApiInstance.v1TranslationAnalyticsGamesGameIdDownloadTranslationAnalyticsReportGet(
		gameId,
		startDateTime,
		endDateTime,
		reportType,
