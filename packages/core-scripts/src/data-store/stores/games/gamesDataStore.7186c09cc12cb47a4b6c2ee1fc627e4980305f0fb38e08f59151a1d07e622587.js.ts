...
const getUniverseMedia = (
	...
	gamesV2ApiInstance.v2GamesUniverseIdMediaGet(universeId, {
...
const getPlayabilityStatus = (
	...
	GamesProvider.RobloxGamesApiModelsResponsePlayabilityStatusResponse[]
> =>
	gamesApiInstance.v1GamesMultigetPlayabilityStatusGet(universeIds, {
		withCredentials: true,
	});
...
const getPlaceDetails = (
	...
	gamesApiInstance.v1GamesMultigetPlaceDetailsGet(placeIds, {
		withCredentials: true,
	});
...
const getProductInfo = (
	...
	gamesApiInstance.v1GamesGamesProductInfoGet(universeIds, {
		withCredentials: true,
	});
...
const getGameIcon = (
	...
	gamesApiInstance.v1GamesUniverseIdIconGet(universeId, {
		withCredentials: true,
	});
...
const getGamePasses = (
	...
	gamePassesApiInstance.v1GamesUniverseIdGamePassesGet(
		universeId,
		sortOrder,
		limit,
		cursor,
...
const getGamesSorts = (
	...
	gamesApiInstance.v1GamesSortsGet(modelGameSortsContext);
...
const getGamesList = (
	...
	gamesApiInstance.v1GamesListGet(
		modelSortToken,
		modelGameFilter,
		modelTimeFilter,
		modelGenreFilter,
