...
const getGameFeatureStatus = (
	...
	automaticTranslationApiInstance.v1AutomaticTranslationGamesGameIdFeatureStatusGet(
		gameId,
		{
...
const getGameAutoLocalizationQuota = (
	...
	automaticTranslationApiInstance.v1AutomaticTranslationGamesGameIdQuotaGet(
		gameId,
		{
			withCredentials: true,
		},
