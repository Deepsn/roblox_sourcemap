...
const getAssetRecommendations = (
	...
	recommendationsApiInstance.v1RecommendationsAssetAssetTypeIdGet(
		assetTypeId,
		numItems,
		contextAssetId,
	);
...
const getBundleRecommendations = (
	...
	bundleApiInstance.v1BundlesBundleIdRecommendationsGet(bundleId, numItems, {
...
const postItemDetails = (
	...
	catalogApiInstance.v1CatalogItemsDetailsPost(model, {
		withCredentials: true,
	});
