...
const developerProductsApiInstance =
	new ThumbnailsProvider.DeveloperProductsApi();
...
const getAvatarHeadshots = (
	...
	avatarApiInstance.v1UsersAvatarHeadshotGet(
		userIds,
		size,
		format,
		isCircular,
...
const getBundles = (
	...
	bundlesApiInstance.v1BundlesThumbnailsGet(
		bundleIds,
		size,
		format,
		isCircular,
