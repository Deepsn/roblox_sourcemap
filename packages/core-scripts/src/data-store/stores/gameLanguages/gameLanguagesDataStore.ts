...
const supportedLanguagesApiInstance =
	new GameInternationalizationProvider.SupportedLanguagesApi();
const supportedLanguagesV2ApiInstance =
	new GameInternationalizationProviderV2.SupportedLanguagesV2Api();
const localizationTableApiInstance =
	new GameInternationalizationProvider.LocalizationTableApi();
...
const getGameLanguageRolloutSettings =
	(): AxiosPromise<GameInternationalizationProvider.RobloxGameInternationalizationApiSupportedLanguagesMetadataResponse> =>
		supportedLanguagesApiInstance.v1SupportedLanguagesMetadataGet({
		...
		languageCodesToAdd.map((languageCode) => ({
			languageCodeType:
				GameInternationalizationProvider
					.RobloxGameInternationalizationApiPatchLanguageLanguageCodeTypeEnum
					.Language,
			languageCode,
		}));
