...
import { httpClient as globalAxios } from "../../../http";
import {
	BASE_PATH,
	COLLECTION_FORMATS,
	RequestArgs,
	...
	return {
		...
		> {
			const localVarAxiosArgs =
				await CatalogApiAxiosParamCreator(configuration).v1CatalogMetadataGet(
					options,
				);
			return (
				axios: AxiosInstance = globalAxios,
		...
		> {
			const localVarAxiosArgs =
				await CatalogApiAxiosParamCreator(configuration).v1CatalogSortsGet(
					options,
				);
			return (
				axios: AxiosInstance = globalAxios,
...
export const CategoryApiFp = function (configuration?: Configuration) {
	return {
		...
		> {
			const localVarAxiosArgs =
				await CategoryApiAxiosParamCreator(configuration).v1AssetToCategoryGet(
					options,
				);
			return (
				axios: AxiosInstance = globalAxios,
		...
		> {
			const localVarAxiosArgs =
				await CategoryApiAxiosParamCreator(
					configuration,
		...
		> {
			const localVarAxiosArgs =
				await CategoryApiAxiosParamCreator(configuration).v1CategoriesGet(
					options,
				);
			return (
				axios: AxiosInstance = globalAxios,
		...
		> {
			const localVarAxiosArgs =
				await CategoryApiAxiosParamCreator(configuration).v1SubcategoriesGet(
					options,
				);
			return (
				axios: AxiosInstance = globalAxios,
...
export const SearchApiFp = function (configuration?: Configuration) {
	return {
		...
		> {
			const localVarAxiosArgs =
				await SearchApiAxiosParamCreator(
					configuration,
