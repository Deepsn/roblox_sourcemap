...
(function ($, window, undefined) {
	...
	function validateTransport(requestedTransport, connection) {
		...
		if ($.isArray(requestedTransport)) {
			// Go through transport array and remove an "invalid" transports
	...
	signalR.fn = signalR.prototype = {
		init: function (url, qs, logging) {
			...
			this._ = {
				keepAliveData: {},
				connectingMessageBuffer: new ConnectingMessageBuffer(
					this,
					function (message) {
		...
		start: function (options, callback) {
			...
			connection._.initHandler =
				signalR.transports._logic.initHandler(connection);
