...
export function useOdpAnalytics(
	ctx: Pick<NodeContext, "analyticsStrings">,
): OdpAnalytics {
	return useMemo(
		() => createOdpAnalytics(ctx.analyticsStrings),
		[ctx.analyticsStrings],
	);
}
