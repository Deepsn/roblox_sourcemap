...
const BUILDER_ICONS: Record<
	string,
	ComponentProps<typeof ListItemLeadingIcon>["name"]
> = {
...
function BulletLeading({
	bullet,
}: {
	bullet: AgreementBullet;
}): JSX.Element | null {
		...
		return (
			<ListItemLeadingAccessorySpacer>
				<img
					src={bullet.icon}
					alt=""
					className="height-600 width-600 [object-fit:contain]"
				/>
			</ListItemLeadingAccessorySpacer>
		);
	}
