...
export const FeatureSubscriptions = {
	...
	MessageStripeAddPaymentMethodDisclosure:
	...
	ErrorStripeSavedCardSomethingWentWrong:
	...
	MessageMonthlySpendLimitExceed:
		"Message.MonthlySpendRestrictionsMonthlyLimitExceed",
	MessageSubscriptionNotAvailableInCountry:
		"Message.SubscriptionNotAvailableInCountry",
	MessageSubscriptionNotAvailableAgeRestriction:
...
export const CommonVerifiedParentalConsent = {
	...
	DescriptionSpendingRestrictionWithSettings:
...
export const SubscriptionErrorCodesToModalContent: {
	...
	[SubscriptionErrorCodes.INVALID_INPUT]:
		FeatureSubscriptions.ErrorGenericError,
	[SubscriptionErrorCodes.INVALID_PRODUCT]:
		FeatureSubscriptions.ErrorGenericError,
	[SubscriptionErrorCodes.INVALID_SALE_LOCATION]:
		FeatureSubscriptions.ErrorGenericError,
	[SubscriptionErrorCodes.PURCHASE_PLATFORM_NOT_SUPPORTED]:
		FeatureSubscriptions.ErrorGenericError,
	[SubscriptionErrorCodes.RESTRICTED_USER]:
		FeatureSubscriptions.MessageCannotPlayInExperience,
	[SubscriptionErrorCodes.SAVED_CC_REQUIRED]:
		FeatureSubscriptions.ErrorGenericError,
	...
	[SubscriptionErrorCodes.USER_ALREADY_SUBSCRIBED]:
		FeatureSubscriptions.ErrorGenericError,
	...
	[SubscriptionErrorCodes.VPC_PENDING_APPROVAL]:
		FeatureSubscriptions.ErrorGenericError,
	[SubscriptionErrorCodes.VPC_REQUIRED]:
		FeatureSubscriptions.MessageParentPermissionVPC,
};
