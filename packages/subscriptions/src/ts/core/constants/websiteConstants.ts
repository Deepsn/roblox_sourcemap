...
export const ANDROID_CANCEL_RENEWAL_URL =
...
export const CHECKOUT_SUCCESS_URL = urlService.getAbsoluteUrl(
	`/upgrades/checkout/success`,
);

export const APP_STORE_CANCEL_HELP_URL =
	"https://help.roblox.com/hc/articles/360029312472";
...
export const BILLING_SETTING_URL = urlService.getAbsoluteUrl(
	"/my/account#!/billing",
);
