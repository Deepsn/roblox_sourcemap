...
export const COUNTER_METRICS = {
	SUBSCRIPTIONS: {
		...
		UPDATE_PAYMENT_METHOD_ADD_CARD_CLICKED:
			"SubscriptionsUpdatePaymentMethodAddCardClicked",
		UPDATE_PAYMENT_METHOD_ADD_CARD_SUCCESS:
			"SubscriptionsUpdatePaymentMethodAddCardSuccess",
		UPDATE_PAYMENT_METHOD_ADD_CARD_FAILED:
			"SubscriptionsUpdatePaymentMethodAddCardFailed",
	...
	API: {
		...
		GET_USER_PREMIUM_SUBSCRIPTION_SUCCEEDED:
			"GetUserPremiumSubscriptionSucceeded",
		...
		GET_SAVED_PAYMENT_PROFILES_RETURNS_NONE:
			"GetSavedPaymentProfilesReturnsNone",
		...
		DELETE_SAVED_PAYMENT_PROFILE_SUCCEEDED:
			"DeleteSavedPaymentProfileSucceeded",
		...
		GET_CREDIT_CONVERSION_METADATA_SUCCEEDED:
			"GetCreditConversionMetadataSucceeded",
		...
		UPDATE_SAVED_PAYMENT_PROFILE_SUCCEEDED:
			"UpdateSavedPaymentProfileSucceeded",
		UPDATE_SAVED_PAYMENT_PROFILE_FAILED: "UpdateSavedPaymentProfileFailed",
		UPDATE_SUBSCRIPTION_PAYMENT_METHOD_CALLED:
			"UpdateSubscriptionPaymentMethodCalled",
		UPDATE_SUBSCRIPTION_PAYMENT_METHOD_SUCCEEDED:
			"UpdateSubscriptionPaymentMethodSucceeded",
		UPDATE_SUBSCRIPTION_PAYMENT_METHOD_FAILED:
			"UpdateSubscriptionPaymentMethodFailed",
	},
	SAVED_PAYMENT_METHODS: {
		...
		UPDATE_SUBSCRIPTION_PAYMENT_METHOD_CLICKED:
			"UpdateSubscriptionPaymentMethodCalled",
		EDIT_SUBSCRIPTION_PAYMENT_METHOD_CLICKED:
			"EditSubscriptionPaymentMethodCalled",
	},
	STRIPE: {
...
export const ProtoEventToCounterEventMap = new Map([
	...
	[
		ManageEventType.CLICK_RESUBSCRIBE,
		COUNTER_METRICS.SUBSCRIPTIONS.CLICK_RESUBSCRIBE,
	],
	[
		ManageEventType.RESUBSCRIBE_SUCCESS,
		COUNTER_METRICS.SUBSCRIPTIONS.RESUBSCRIBE_SUCCESS,
	],
]);
