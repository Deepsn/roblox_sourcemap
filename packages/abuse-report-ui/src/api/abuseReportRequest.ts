export type AbuseReportAttributes = Readonly<
...
export type AbuseReportRequestInput =
	| AttributesRequestInput
	| LegacyTargetRequestInput;
...
export const serializeAbuseReportAttributes = (
	...
	const sortedEntries = Object.entries(attributes).sort(
		([leftKey], [rightKey]) => {
