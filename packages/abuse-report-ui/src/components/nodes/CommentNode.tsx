...
const CommentNode = ({
	...
	const isOverLimit = Boolean(
		maxLength && getCodePointLength(textValue) > maxLength,
	);
	...
	const ariaLabel = textAreaAriaLabel
		? translateToStringOnly(textAreaAriaLabel)
		: undefined;
	const ariaLabelledBy =
		!ariaLabel && textAreaLabel ? visibleLabelId : undefined;
