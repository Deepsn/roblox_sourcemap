...
const toDiscountInformation = (
	...
	return {
		...
		totalDiscountAmount,
		totalDiscountPercentage: priceDiscountDetails.reduce(
...
const DeveloperProductCard = ({
	...
	const [ItemPurchase, itemPurchaseService] =
		window.RobloxItemPurchase.createItemPurchase();
	const developerProductDetailsLink =
		developerProductConstants.url.developerProductDetailsPage(
			universeId.toString(),
