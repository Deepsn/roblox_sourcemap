...
const UpsellBannerContentsCompact: React.FC<
	TUpsellBannerContentsCompactProps
> = ({ buttonProps, titleText, iconClassName, titleTextClassName }) => {
	return (
		<div className="flex flex-row grow-1 gap-medium items-center">
			...
			<div className={classnames(titleTextClassName, "grow-1")}>
				{titleText}
			</div>
			{buttonProps && (
				<Button
