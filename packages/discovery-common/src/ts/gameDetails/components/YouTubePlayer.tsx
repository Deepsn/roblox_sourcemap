...
const YouTubePlayer = ({
	...
	const internalPlayerRef = useRef<
		ReturnType<typeof youTubePlayer> | undefined
	>(undefined);
	...
	useAutoPlayVideoCarouselItem(
		...
		currentState === YouTubePlayerState.Playing ||
			currentState === YouTubePlayerState.Buffering,
	...
	useEffect(() => {
		internalPlayerRef.current = youTubePlayer(
			videoHash,
			getYouTubePlayerConfig(videoHash),
		);
