...
import {
	getPlayButtonContextualMessage,
...
export const UnavailableExperience = ({
	translate,
}: WithTranslationsProps): JSX.Element => {
	const { universeId = "", placeId = "" } =
		metadataConstants.metadataData() || {};
	const { playabilityStatus, unplayableDisplayText } =
			...
			<div className="flex flex-col items-center gap-medium">
				...
				<div className="flex flex-col gap-xsmall">
					<h3 className="text-heading-small">
						{translate(
							FeatureExperienceDetails.UpdateMaturitySettingModalLabelTitle,
						)}
					</h3>
					<h4
...
export default withTranslations(
	...
	unavailableExperienceTranslationConfig,
);
