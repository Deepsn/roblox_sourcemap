...
const EdpUpsellCardContainer = ({
	...
	const handleUpsellClick = () => {
		...
		window.Roblox.AccessManagementUpsellV2Service.startAccessManagementUpsell({
			...
			.catch((error) => {
				window.EventTracker?.fireEvent(
					edpUpsellCounterEvents.StartUpsellFailed,
				);
			});
	};
