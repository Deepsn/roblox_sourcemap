...
export const AboutTab = ({
	...
	const { gameDetails, hasError: hasGameDetailsError } =
		useGameDetailsForUniverseId(universeId);
	...
	const shouldShowExperienceContent =
		...
		gameDetails.isContentRestricted !== true;
			...
			{shouldShowExperienceContent && (
				<React.Fragment>
					{experienceDetailsNoticeType !== undefined &&
						experienceDetailsNoticeType !== "" && (
							<ExperienceNotice
								noticeType={experienceDetailsNoticeType}
								translate={translate}
							/>
						)}
