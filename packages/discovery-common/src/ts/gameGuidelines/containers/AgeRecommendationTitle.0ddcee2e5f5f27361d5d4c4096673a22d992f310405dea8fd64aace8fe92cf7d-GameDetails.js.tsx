...
export const AgeRecommendationTitle = ({
	...
	const [
		isLoadingCommunicationStrongLanguage,
		setIsLoadingCommunicationStrongLanguage,
	] = useState(false);
	...
	const ageRecommendationDetails =
		ageRecommendationData?.ageRecommendationDetails;
	...
	const experienceGuidelines = useMemo<ExperienceGuidelines | null>(() => {
		const ageRecommendation =
			ageRecommendationDetails?.summary.ageRecommendation;
      ...
      */
		...
		return {
			...
			ageRecommendationBracket:
				ageRecommendation.displayNameWithHeaderShort ??
	...
	const isBusy =
		isLoadingCommunicationStrongLanguage || isLoadingAgeRecommendationData;
