export const homePage = {
	...
	omniRecommendationFeedStatsLoggingErrorEvent:
...
export const searchLandingPage = {
	searchLandingPageFetchRecommendationsError:
		"SearchLandingPageFetchRecommendationsError",
	searchLandingPageFetchRecommendationsSuccess:
		"SearchLandingPageFetchRecommendationsSuccess",
	searchLandingPageMissingSessionInfoError:
		"SearchLandingPageMissingSessionInfoError",
...
export const userSignal = {
	ExplicitFeedbackUnexpectedAppPageCounterEvent:
		"ExplicitFeedbackUnexpectedAppPage",
	...
	ExplicitFeedbackUserSignalFailedCounterEvent:
		"ExplicitFeedbackUserSignalFailed",
	ExplicitFeedbackSignalStateRevertFailedDueToMissingToggle:
		"ExplicitFeedbackSignalStateRevertFailedDueToMissingToggle",
	ExplicitFeedbackDisabledDueToMissingSetter:
		"ExplicitFeedbackDisabledDueToMissingSetter",
	HiddenStateUndoFailedDueToMissingSetter:
		"HiddenStateUndoFailedDueToMissingSetter",
};
