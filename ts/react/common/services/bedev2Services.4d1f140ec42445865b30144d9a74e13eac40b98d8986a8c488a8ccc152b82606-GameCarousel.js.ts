...
export const getOmniRecommendationsMetadata = async (
	...
	const { data } =
		await httpService.post<TGetOmniRecommendationsMetadataResponse>(
...
const postSurveyResults = async (
	...
	const response = await httpService.post<TSendSurveyResultsResponse>(
		urlConfig,
		requestBody,
	);
	return response.data;
...
const postUserSignal = async (
	...
	const response = await httpService.post<TPostUserSignalResponse>(
		urlConfig,
		requestBody,
	);
	return response.data;
