...
export const AccountSwitcherContainer = ({
	...
	function renderSwitchAccountErrorConfirmationModal() {
		const switcherErrorConfirmationModalParameters = {
			...
			localizedTitleText: translate(
				errorCasePlaceholderStrings.UnavailableHeaderText,
			),
			localizedBodyText: translate(
				errorCasePlaceholderStrings.CannotBeSwitchedHelpText,
			),
		...
		AccountSwitcherService.renderBaseConfirmationModal(
			switcherErrorConfirmationModalParameters,
		);
	}
			...
			if (loggedInUsers) {
				...
				try {
					...
					const switcherModalPopulationFailureParams = {
						...
						localizedBodyText: translate(
							errorCasePlaceholderStrings.NotWorkingTryLaterText,
						),
						localizedPrimaryButtonText: translate(
							commonUiTranslationKeys.ActionOK,
						),
						primaryButtonCallback: () => {
							// no op
						},
					...
					AccountSwitcherService.renderBaseConfirmationModal(
						switcherModalPopulationFailureParams,
					);
					return;
				}
				const {
			...
			>
				...
				{currentModal === ModalType.LogoutAllAccountsModalType && (
					<AccountSwitcherBaseConfirmationModal
						...
						)} // TODO switch to Header.LogoutAllAccounts when translations ready
						...
						localizedPrimaryButtonText={
							logoutAllAccountsPlaceholderStrings.LogoutAllAccountsText
						}
						secondaryButtonCallback={handleModalDismiss}
						localizedSecondaryButtonText={
							logoutAllAccountsPlaceholderStrings.StayLoggedInText
						}
