...
iconComponent, containerOverrides, permitLinkClickPropagation, linkComponent }) => {
    ...
    const wrappedTitleSubtitleContent = useMemo(() => {
        return (React.createElement(MaybeLinkActionWrapper, { containerClassName: titleSubtitleContainer, callback: onTitleActivated, linkPath: titleLinkPath, ariaLabel: titleText, dataTestId: 'section-header-title-subtitle-container', permitLinkClickPropagation: permitLinkClickPropagation, linkComponent: linkComponent },
            titleElement,
            subtitleElement));
    }, [
        onTitleActivated,
