...
const useStyles$g = makeStyles()((_theme, { color, width, iconOverrideStyles }) => ({
    iconBaseStyles: {
        display: 'inline-flex',
        alignItems: 'center',
...
const Icon = ({ iconClassName, color, width, iconOverrideStyles }) => {
    const { classes: { iconBaseStyles, iconOverride } } = useStyles$g({ color, width, iconOverrideStyles: iconOverrideStyles || {} });
...
const useStyles$e = makeStyles()((_theme, { gap, textColor, fontStyle, containerOverrideStyles, textOverrideStyles }) => ({
    textIconRow: {
        display: 'inline-flex',
        alignItems: 'center',
        gap: `${gap}px`,
...
const TextIconRow = ({ onActivated, linkPath, text, textColor, fontStyle, gap = 0, iconClassName, iconWidth, iconColor, iconFirst = false, containerOverrides, textOverrides, iconOverrides }) => {
    ...
    const { classes: { textIconRow, textIconRowText, textOverride, iconBaseStyles } } = useStyles$e({
        gap,
        textColor,
        fontStyle,
        containerOverrideStyles,
...
const AttributionTextContent = ({ title, titleComponent, subtitle, textColor, titleFontStyle, subtitleFontStyle, subtitleMaxLines = 1, textGap = 0 }) => {
    ...
    return (React.createElement("div", { className: classes.attributionTextContentContainer, "data-testid": 'attribution-text-content-container' },
        titleComponent || (React.createElement(TextIconRow, { text: title, fontStyle: titleFontStyle, textColor: textColor })),
 ...
 * />
 */
const AttributionRow = ({ title, titleComponent, subtitle, textColor, height, imageComponent, rightButtonContent, titleFontStyle, subtitleFontStyle, subtitleMaxLines, titleSubtitleGap }) => {
    ...
    return (React.createElement("div", { className: attributionRowContainer },
        ...
        React.createElement(AttributionTextContent, { title: title, titleComponent: titleComponent, subtitle: subtitle, textColor: textColor, titleFontStyle: titleFontStyle, subtitleFontStyle: subtitleFontStyle, subtitleMaxLines: subtitleMaxLines, textGap: titleSubtitleGap }),
...
const useStyles$d = makeStyles()((_theme, { itemWidth, columnGap, sideMargin, gapBetweenHeaderAndItems, scrollArrowBackgroundColor, scrollArrowBoxShadowColor, scrollArrowBaseClassName, scrollArrowPrevClassName, scrollArrowNextClassName }) => ({
...
const CollectionCarousel = ({ itemsContainerRef, items, renderItem, collectionItemSize, updateItemsPerRow, layoutOverrides, headerComponent, gapBetweenHeaderAndItems, isHorizontalScrollEnabled, scrollArrowBackgroundColor, scrollArrowBoxShadowColor, thresholdFromEnd, onReachedThresholdFromEnd, reportHorizontalScrollTelemetry }) => {
    ...
    const { classes: { collectionCarouselContainer, carouselContainer, carousel, carouselItem } } = useStyles$d({
        itemWidth,
        columnGap,
        sideMargin,
...
const useStyles$c = makeStyles()((_theme, { itemWidth, columnGap, sideMargin, gapBetweenHeaderAndItems }) => ({
...
const CollectionGrid = ({ itemsContainerRef, items, renderItem, collectionItemSize, updateItemsPerRow, layoutOverrides, headerComponent, gapBetweenHeaderAndItems }) => {
    ...
    const { classes: { collectionGridContainer, grid, gridItem } } = useStyles$c({
        itemWidth,
        columnGap,
        sideMargin,
        gapBetweenHeaderAndItems
...
const useStyles$b = makeStyles()((_theme, { iconWidth, avatarContainerBackgroundColor, avatarImageBackgroundColor, avatarBorderColor, maxZIndex }) => ({
    facepileContainer: {
        width: 'fit-content',
        display: 'flex',
        alignItems: 'center'
...
const GameTileActiveFriendsFacepile = ({ avatarThumbnails, iconWidth, avatarContainerBackgroundColor, avatarImageBackgroundColor, avatarBorderColor }) => {
    const { classes: { facepileContainer, avatarContainer } } = useStyles$b({
        iconWidth,
...
const useStyles$a = makeStyles()((_theme, { hasTitleImage, forceSmallView, forceMediumView, forceSmallOrMediumView, minCardHeight, titleImageHeightPercentLarge, titleImageHeightPercentCompact, titleImageAspectRatio }) => ({
...
const HeroUnitContent = ({ title, subtitle, titleImageComponent, heroUnitRef, gradient, gradientHeightPercent, gradientWidthPercent, bottomRowComponent, overlayPillComponent, forceViewportWidth, titleImageAspectRatio = 3, titleImageHeightPercentage, minCardHeight }) => {
    ...
    const { classes: { heroUnitContentContainer, heroUnitTitleContainer, heroUnitTitle, heroUnitSubtitle, heroUnitTitleImageContainer } } = useStyles$a({
...
const useStyles$9 = makeStyles()((_theme, { minCardHeight, forceSmallOrMediumView, enableBackgroundAnimation }) => ({
...
const HeroUnitBackground = ({ backgroundImageComponent, forceViewportWidth, minCardHeight, enableBackgroundAnimation }) => {
    ...
    const { classes: { heroUnitBackgroundWindow, heroUnitBackgroundContainer } } = useStyles$9({
        minCardHeight,
        forceSmallOrMediumView,
        enableBackgroundAnimation
    });
...
const useStyles$8 = makeStyles()((_theme, { forceViewportWidth, maxForegroundHeightPercentString, forceSmallOrMediumView, minForegroundHeightPercentString, foregroundScaleFactor, foregroundAspectRatio, enableForegroundAnimation }) => ({
    heroUnitContainer: {
        width: '100%',
        position: 'relative',
        display: 'flex',
...
const HeroUnit = ({ title, subtitle, titleImageComponent, foregroundImageComponent, backgroundImageComponent, gradient, gradientHeightPercent = 0.5, gradientWidthPercent = 1, backgroundClickAction: onBackgroundClick, backgroundClickLinkPath, bottomRowComponent, overlayPillComponent, minForegroundHeightPercent = 0.8, maxForegroundHeightPercent = 1, forceViewportWidth, titleImageAspectRatio = 3, titleImageHeightPercentage, minCardHeight = 262, foregroundAspectRatio = 1, enableBackgroundAnimation = true, enableForegroundAnimation = true }) => {
    ...
    const { classes: { heroUnitContainer, heroUnitForegroundContainer, heroUnitTopSpacer } } = useStyles$8({
        forceViewportWidth,
...
const useStyles$7 = makeStyles()((_theme, { textColor, fontStyle, containerOverrideStyles }) => ({
    labelTextSpan: {
        backgroundColor: 'transparent',
        ...getTextStyles(defaultTextDataAttributeConfig, textColor, fontStyle)
    },
...
const HeroUnitBottomRow = ({ ctaButton, labelText, labelTextColor = 'white', labelTextFontStyle, rightLabelContent, containerOverrides }) => {
    ...
    const { classes: { labelTextSpan, bottomRowContainer } } = useStyles$7({
...
const useStyles$6 = makeStyles()((_theme, { verticalGap, containerOverrideStyles }) => ({
    sectionHeader: {
        position: 'relative',
        display: 'flex',
        justifyContent: 'space-between',
...
iconComponent, containerOverrides }) => {
    ...
    const { classes: { sectionHeader, titleSubtitleContainer } } = useStyles$6({
        verticalGap,
        containerOverrideStyles
    });
...
const useStyles$5 = makeStyles()((_theme, { padding, containerOverrideStyles }) => {
...
const SlotOverlay = ({ topLeftSlot, topMiddleSlot, topRightSlot, centerLeftSlot, centerMiddleSlot, centerRightSlot, bottomLeftSlot, bottomMiddleSlot, bottomRightSlot, padding = 0, containerOverrides, children }) => {
    ...
    const { classes } = useStyles$5({ padding, containerOverrideStyles });
...
export { AssociatedItemsRow, AttributionRow, AttributionTextContent, CollectionCarousel, CollectionGrid, CollectionItemSize, CountdownTextIconRow, CtaButton, DetailsPageHeader, GameTileActiveFriendsFacepile, Gradient, HeroUnit, HeroUnitBottomRow, ImageWithGradient, MaybeLinkActionWrapper, OverlayPill, Page, SectionHeader, SlotOverlay, TAutomaticSize, Text, TextIconRow, TextPill, Tile, TileFooter, VerticalFeed, useElementWidthResizeObserver };
