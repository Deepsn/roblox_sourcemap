...
function TopUpBanner(
	props: TopUpBannerProps & WithTranslationsProps,
): JSX.Element | null {
		...
		<div className="top-up-container">
			{topUp.giftCard ? (
				...
				>
					...
					<img
						src={TopUpGiftCardBackDec}
						className="top-up-gift-card-back"
						alt=""
					/>
					<img
						src={TopUpGiftCardFrontDec}
						className="top-up-gift-card-front"
						alt=""
					/>
					<div className="top-up-body">
						...
						<a
							className="top-up-button btn-cta-md"
							href={topUp.buttonUrl}
							target="_self"
						>
				...
				>
					...
					<div className="top-up-body">
						<h1 className="top-up-header">
							{translate(topUp.headerText || "")}
						</h1>
						<div className="top-up-message">{translate(topUp.messageText)}</div>
						<a
							className="top-up-button btn-cta-md"
