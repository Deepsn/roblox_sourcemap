...
const MarketplaceOfferBanner = ({
	className,
}: MarketplaceOfferBannerProps): JSX.Element | null => {
	const { offer, showOfferBanner, dismissOfferBanner, openOfferModal } =
		...
		>
			{iconName && (
				<Icon
					name={iconName}
					size="Medium"
					className="marketplace-offer-banner-icon"
				/>
			)}
