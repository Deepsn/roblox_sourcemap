			...
			<div className="input-group">
					...
					{!!searchInputValue.length && autocompleteSuggestions.show && (
						<div className="autocomplete-dropdown-menu open">
							<ul id="autocomplete-list" className="dropdown-menu" role="menu">
								{autocompleteSuggestions.suggestions.map(
									(suggestion, index) => (
										<li
											id={`autocomplete-suggestion-li-${index}`}
				...
				{searchBarOnly ? (
					<React.Fragment>
						<div
							ref={dropdownRef}
							className="input-group-btn-category input-group-btn"
						>
							<button
