...
const useCreatorBreadcrumb = (
	...
	const [customCreatorSelected, setCustomCreatorSelected] = useState<
		boolean | undefined
	>();
	...
	const [showCreatorBreadcrumb, setShowCreatorBreadcrumb] = useState<
		boolean | undefined
	>(false);
	...
	useEffect(() => {
		setShowCreatorBreadcrumb(
			!!(
				customCreatorSelected &&
				creatorBreadcrumb &&
				creatorBreadcrumb.length > 0
			),
		);
