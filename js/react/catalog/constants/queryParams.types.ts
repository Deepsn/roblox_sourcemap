...
type ValidateAllKeysPresent = {
	[K in AllQueryParamKeys]: K extends (typeof validQueryParamKeys)[number]
		? true
		: never;
};
type ValidateNoExtraKeys =
	(typeof validQueryParamKeys)[number] extends AllQueryParamKeys ? true : never;

// These lines will cause compile errors if validQueryParamKeys doesn't match QueryParams exactly
// eslint-disable-next-line @typescript-eslint/no-unused-vars
const validateAllKeysPresent: ValidateAllKeysPresent =
	{} as ValidateAllKeysPresent;
// eslint-disable-next-line @typescript-eslint/no-unused-vars
