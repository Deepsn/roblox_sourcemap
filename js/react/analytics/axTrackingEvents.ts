...
export enum TPurchaseSource {
	...
	// Avatar editor "expired items" repurchase dialog. The avatar component is a
	// workspace package that can't import this enum, so it sends this string
	// literal directly — keep the value in sync with ExpiredItemsDialog.
	AvatarEditorExpiredItems = "AvatarEditorExpiredItems",
}
...
export const trackItemCardClick = (
	source: TItemCardSource,
	item: TTrackedItem,
): void => {
...
export const trackShoppingCartAddClick = (
...
export const trackPurchaseButtonClick = (
