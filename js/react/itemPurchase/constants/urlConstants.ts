...
export default {
	...
	getCurrentUserBalance: (userId: string | number) =>
	...
	getCollectibleItemDetailsUrl: () =>
		`${apiGatewayUrl}/marketplace-items/v1/items/details`,
	...
	postBulkPurchaseUrl: () =>
		`${apiGatewayUrl}/cloud/v2/avatar-marketplace-orders`,
	...
	getSubscriptionsMetadataUrl: () =>
		`${apiGatewayUrl}/roblox-subscriptions/v1/metadata`,
