...
let cursorPagination = angular
	.module("cursorPagination", ["cursorPaginationHtmlTemplate"])
	.config([
		"$qProvider",
		"languageResourceProvider",
		function ($qProvider, languageResourceProvider) {
			/**
			...
			const commonUIControlsResources =
