...
Roblox.LangDynamic["Authentication.Login"] = {
	...
	"Error.PasskeyOnlyAccount":
		"Your account only has a passkey set up for sign-in. Try signing in with your passkey or recover your account.",
	...
	"Description.SwitchAccountEmailPreferences":
		"To manage your email preferences, switch to your Roblox account with parent privileges.",
	"Description.SwitchAccountViewActivity":
...
window.Roblox &&
	...
	window.Roblox.BundleDetector.bundleDetected(
		"DynamicLocalizationResourceScript_Authentication.Login",
	);
