...
Roblox.LangDynamic["Common.VisitGame"] = {
	...
	"Response.Dialog.MacFirstInstruction":
		"Once downloaded, double-click the {startBold}Roblox.dmg{endBold} file in your Downloads folder.",
	"Response.Dialog.WindowsFirstInstruction":
		"Once downloaded, double-click the {startBold}RobloxPlayerInstaller.exe{endBold} file in your Downloads folder.",
	"Response.Dialog.SecondInstruction":
		"Double-click the {startBold}RobloxPlayerInstaller{endBold} to install the app.",
	"Response.Dialog.ThirdInstruction":
		"Follow the instructions to install Roblox to your computer.",
...
window.Roblox &&
	...
	window.Roblox.BundleDetector.bundleDetected(
		"DynamicLocalizationResourceScript_Common.VisitGame",
	);
