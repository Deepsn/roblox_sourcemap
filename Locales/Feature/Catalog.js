...
Roblox.LangDynamic["Feature.Catalog"] = {
	...
	"Message.AvatarUpdateFailed":
		"Avatar update failed. Please try on the Avatar Editor.",
	"Message.CharacterCreationFailed":
		"Character creation failed. Please try on the Avatar Editor.",
	"Message.PurchaseComplete": "Purchase Complete",
	"Action.NotNow": "Not Now",
	"Message.SuccessfulAcquisitionOfItems":
		"You have successfully acquired {numberOfItems} items.",
	...
	"Label.Checkout.CheckoutButtonFtuxTooltip":
		"See and remove items you're trying on here",
	...
	"Checkout.Title.PurchasedFailedPlural":
		"{count} items could not be purchased",
	...
	"Message.PriceCouldBeDifferent":
		"Item type determines an item's pricing rules",
	...
	"Title.Checkout.OfferFailedToFetch":
		"Failed to fetch available offers, please try again later.",
	"Title.Checkout.OfferFailedToUpdate":
		"Failed to toggle offer, please try again later.",
...
window.Roblox &&
	...
	window.Roblox.BundleDetector.bundleDetected(
		"DynamicLocalizationResourceScript_Feature.Catalog",
	);
