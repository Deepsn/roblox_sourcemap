...
Roblox.LangDynamic["Feature.RobloxSubscription"] = {
	...
	"Description.Benefit.DiscountAnnualSavingsEstimateDisclaimer":
		"Based on your past purchases",
	"Title.Benefits": "Why join {productShort}?",
	"Description.BillingInfo":
		"{price}/{periodType, select,\n  Week {week}\n  Month {month}\n  Year {year}\n  other {periodType}\n}",
	"Description.SubscribeLegalDisclaimer":
		"Legal text placeholder. Subscription renews automatically unless canceled. See full terms for details.",
	...
	"Description.Benefit.DiscountNextAlt":
		"{discountPercent} off unlocks in {dayCount, plural,\n  =1 {{dayCount} day}\n  other {{dayCount} days}\n}",
	"Label.Ends": "Ends",
	...
	"Action.PricePerMonth":
		"{price}/{periodType, select,\n Week {week}\n Month {month}\n Year {year}\n other {periodType} \n}",
	"Title.RobuxAmount": "{RobuxAmount} Robux",
	"Label.BlackbirdVTDiscountFirst":
		"{discountPercent}% off in-game items, avatars, and more",
	...
	"Body.AlreadySubscribed":
		"Your Plus subscription already provides in-game benefits.",
	"Title.UnsupportedPlatform": "Roblox Plus unavailable here",
	"Body.UnsupportedPlatform":
	...
	"Description.ExclusiveBenefitsV2":
		"More fun for less Robux. Subscribe to Roblox Plus.",
	...
	"Description.BannerBodyUnboxed":
		"Head to your inventory to see what's inside.",
	...
	"Description.ReferralIneligible":
	...
	"Action.Get": "Get",
	"Description.Benefit.DiscountBaseSubtitleV2":
		"{discountPercentTier1} off for the first {discountTier1Days} days, then {discountPercentTier2} off",
	...
	"Description.Benefit.AvatarBackgroundSubtitle":
		"Choose or create a background for your avatar",
	"Description.Benefit.ProfileFrames": "Profile frames",
	"Description.Benefit.ProfileFramesSubtitle":
		"Customize your avatar with exclusive frames",
...
window.Roblox &&
	...
	window.Roblox.BundleDetector.bundleDetected(
		"DynamicLocalizationResourceScript_Feature.RobloxSubscription",
	);
