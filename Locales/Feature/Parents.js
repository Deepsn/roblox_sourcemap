...
Roblox.LangDynamic["Feature.Parents"] = {
	...
	"Message.ExitChangeBirthdateConsent":
		"Your child won’t be able to update their birthday without approval",
	...
	"Description.ParentRestartSession":
		"To approve your child’s request, send another request from your child’s device.",
	...
	"Description.InvalidLink":
		"This link is no longer valid. To approve your child’s request, send another request from your child’s device.",
	"Description.InFlowLogOut":
		"To finish setup, log out of your current session and log back in.",
	"Description.ConsentRequestLogOut":
		"To approve your child’s request, log out of your current session and log back in.",
	...
	"Description.IdentityVerification":
		"To link your account to your child’s, first verify you’re an adult",
	...
	"Message.EmailIneligibleV2":
		"This email isn't eligible. Try a different email.",
	...
	"Message.RequestCreatedEmailNotSent":
		"After linking a Roblox account, your parent will see this request in parental controls.",
	...
	"Description.VPCRequestRobloxConnect":
		"This allows your child to chat with friends across Roblox.",
	...
	"Description.VPCRequestScreentime":
		"This will update the daily limit on the time your child can spend on Roblox.",
	...
	"Description.VPCRequestPhoneNumberDiscoverability":
		"This helps people who already have your child's phone number add them as a friend on Roblox.",
	...
	"Message.UpdateSettingRequestDenied":
		"Your child’s {settingName} has not been updated",
	"Message.ExitConsent":
		"Please confirm you do not want to approve your child’s request",
	...
	"Message.TooManyAttemptAskParent":
		"Too many attempts. If you’ve already requested permission, ask your parent to check their email.",
	"Message.ConflictingPendingConsent":
		"You’ve already requested permission. To submit a new request, first cancel your request in Settings.",
	"Description.LinToChildV2":
		"Link accounts to access parental controls and insights",
	...
	"Description.LinkToChildWithControl":
		"Link accounts to access parental controls and insights",
	"Description.LinkToChild":
		"Link accounts to approve certain actions for your child",
	...
	"Description.ManageFriendConsent":
		"This allows {displayName} to send your child a friend request.",
	...
	"Heading.VoiceDataForProductImprovementsSettingName":
		"Voice data for product improvements setting",
	...
	"Description.SensitiveIssuesSettingNameInContext":
	...
	"Heading.ConversationalRequest.InventoryPrivacy":
		"Who can see your child’s inventory?",
	"Heading.ConversationalRequest.ScreenTimeLimit":
		"How long can your child spend on Roblox each day?",
	"Heading.ConversationalRequest.UnlockAccount":
		"Do you want to unlock your child’s account?",
	"Heading.ConversationalRequest.ExperienceChat":
		"Can your child use chat in a game or experience?",
	"Heading.ConversationalRequest.ExperienceDirectChat":
		"Can your child use direct chat in a game or experience?",
	"Heading.ConversationalRequest.MonthlySpendingLimit":
		"How much can your child spend on Roblox per month?",
	"Heading.ConversationalRequest.EnablePurchases":
		"Can your child make purchases on Roblox?",
	...
	"Heading.ConversationalRequest.SocialNetworkVisibility":
		"Who can see the links to your child’s social network profiles?",
	"Heading.ConversationalRequest.EmailNotifications":
		"Do you want your child to be able to opt in for emails from Roblox?",
	"Heading.ConversationalRequest.MobilePushNotifications":
		"Do you want to allow your child to enable mobile push notifications from Roblox?",
	...
	"Heading.ConversationalRequest.AddTrustedConnection":
		"Can your child add {displayName} as a trusted friend?",
	...
	"Description.VPCRequestGroupPartyV2.FriendsRename":
		"This allows your child to join an experience together with more than one friend.",
	...
	"Description.VPCRequestOneOnOnePartyV2.FriendsRename":
		"This allows your child to join an experience together with a friend.",
	"Description.VPCRequestOnlineStatusV2.FriendsRename":
		"This allows friends to see when your child is online.",
	"Description.VPCRequestPrivateServersV2.FriendsRename":
		"This allows your child to join or be joined by their friends in private servers.",
	...
	"Description.VPCRequestRobloxConnectGroupChatV2.FriendsRename":
		"This allows your child to add friends and be added by friends to group chats.",
	"Description.VPCRequestRobloxConnectV2.FriendsRename":
		"This allows your child to chat with friends across Roblox.",
	...
	"Description.VPCRequestStandaloneLinkingV2.FriendsRename":
		"This will give you access to parental controls and insights on your child's screen time, friends, spending, and more.",
	"Heading.ConversationalRequest.AddTrustedFriend":
		"Can your child add {displayName} as a trusted friend?",
	"Heading.ConversationalRequest.FriendDiscovery.FriendsRename":
		"Who can add your child as a friend on Roblox using their phone number?",
	"Message.AddTrustedFriendDenied":
		"{displayName} has not been added as a trusted friend for your child.",
	"Message.AddTrustedFriendSuccess":
		"{displayName} will be added as a trusted friend for your child",
	"Description.VPCRequestCurrentExperienceSharingV2.TFRename":
		"This allows your child's friends to see which experience they are in and join them.",
	...
	"Description.PartySettingConsent":
		"This allows your child to join an experience together with friends.",
	"Description.PartyChatConsent":
		"This allows your child to chat with friends when they’re in the same Party.",
	"Description.PartyVoiceChatConsent":
		"This allows your child to use Voice Chat with trusted friends when they’re in the same Party.",
	...
	"Description.ApproveExperienceEmailSubject":
		"Review your child's request to join {experienceName}",
	...
	"Heading.ConversationalRequest.ShareActivityUpdatesV2":
		"Can your child share updates about their recent activity with their friends?",
	"Description.VPCRequestShareActivityUpdatesV3":
		"This allows your child's friends to receive updates about their recent activity on Roblox.",
	...
	"Description.TrustedConnectionTeamCreateGame":
		"For game {gameName} by creator group {creatorName}.",
	...
	"ODPChallenge.ToS.Headline":
		"Your child is asking for parental approval. Let's get you set up.",
	"ODPChallenge.ToS.Subtitle":
		"Verify your age and set up controls to keep your family safer on Roblox.",
	"ODPChallenge.ToS.ContinueLabel": "Continue",
	"ODPChallenge.ToS.Bullet.Scale.Title":
		"Millions of kids play Roblox every day",
	"ODPChallenge.ToS.Bullet.Scale.Description":
		"They explore, create, and connect with friends across thousands of games.",
	"ODPChallenge.ToS.Bullet.Safety.Title": "Safety is built in",
	"ODPChallenge.ToS.Bullet.Safety.Description":
		"Age checks, content filters, and privacy settings help keep your child safer.",
	"ODPChallenge.ToS.LegalParagraph":
		"By tapping “Continue,” you represent that you are this child’s parent or legal guardian. You also agree,  on behalf of yourself and your child, to the {termsLink}, including the arbitration clause, and acknowledge the {privacyLink}.",
	...
	"Description.ODPUpgradeEmailDataPractices":
		"This email will be associated with your Roblox parent account. To learn more about our data practices, please see our {privacyPolicyLinkStart}Privacy Policy{privacyPolicyLinkEnd}.",
	"Description.ODPUpgradeEmailEntry":
		"Create your parent account in a few taps and connect to {childName}.",
	"Description.ODPUpgradeEmailEntryNoName":
		"Create your parent account in a few taps and connect to your child.",
	"Description.ODPUpgradeEmailUpdate":
		"Update the email you'd like to use to create your account with parent privileges.",
	"Description.ODPUpgradeEmailUpdateDataPractices":
		"This email will be associated with your Roblox account with parent privileges. To learn more about our data practices, please see our {privacyPolicyLinkStart}Privacy Policy{privacyPolicyLinkEnd}.",
	"Description.ODPUpgradeUpsell":
		"You can hand the device back to your child — but if you'd like to keep a closer eye on things, add an email to set up a parent account.",
	"Description.ODPUpgradeUpsellActivityEmails":
		"Get emails about your child's activity, like screen time, friends, and spending.",
	"Description.ODPUpgradeUpsellFeatureTransitions":
		"Know when feature management transitions to them as they grow up.",
	"Description.ODPUpgradeUpsellRemoteSettings":
		"Review and manage settings from your own device, anytime.",
	"Description.OnDeviceParent.ConfirmPin":
		"Enter it again to make sure it matches.",
	"Description.OnDeviceParent.CreatePin":
		"Use it to approve future requests without needing to verify your age again. Keep it secure.",
	"Description.OnDeviceParent.RemovePin":
		"This action cannot be undone. To set up a PIN again, you will need to go through the verification process on your child’s device.",
	"Message.OnDeviceParent.PinMismatch": "The PIN you entered doesn't match.",
	"Description.OnDeviceParent.UpdatePin":
		"Choose something memorable and save it somewhere safe.",
	...
	"Response.ODPUpgradeEmailFailedRequestCancelled":
		"We couldn't send that email, and your previous request is no longer valid. Enter an email to try again.",
	"Description.ODPRequestExpired":
		"The request expired due to inactivity, restart the request",
	"Description.ODPSessionExpired":
		"This session and request expired due to inactivity. Visit Settings > Parental Controls to make additional changes",
...
window.Roblox &&
	...
	window.Roblox.BundleDetector.bundleDetected(
		"DynamicLocalizationResourceScript_Feature.Parents",
	);
