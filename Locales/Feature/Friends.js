...
Roblox.LangDynamic["Feature.Friends"] = {
	...
	"Label.DeclineAllBackgrounded":
		"Ignoring all requests. This may take a minute.",
	"Error.ParentalControlUnblockError":
	...
	"Error.UnblockTargetNotBlockedError":
		"This user isn’t blocked—you're all set!",
	"Label.AddConnectionsHint": "Connections make Roblox fun!",
	"Label.AddConnectionsHintBody":
		"Add people you already know or discover new Connections",
	"Message.ViewAndConnectHint":
		"View Connection requests and add people you already know",
	"Text.NoConnections":
		"You haven't added any Connections yet. To get started, find and add Connections.",
	PluralMutualConnections: "are mutual Connections",
	"Heading.MyConnections": "My Friends",
	"Message.ConnectionsTabTooltip":
	...
	"Label.WebMutualConnection":
		"{mutualConnectionsCount, plural, =0 {# mutual Connections} =1 {# mutual Connection} other {# mutual Connections}}",
	...
	"TrustedConnection.Action.RemoveTrustedConnection":
		"Remove Trusted Connection",
	"TrustedConnection.Toast.TrustedConnectionRemoved":
		"Trusted Connection removed",
	"LinkText.LearnMore": "Learn more",
	"Button.GotIt": "Got it",
	"Label.NewConnection": "New Connection",
	"Error.UnblockTargetBlockedOnPlatform":
	...
	"TrustedConnection.Accept.Toast":
		"{displayName} @{userName} accepted your Trusted Connection request",
	"TrustedConnection.Sent.Toast":
		"{displayName} @{userName} sent you a Trusted Connection request",
	"TrustedConnection.Accepted.Toast":
		"{displayName} @{userName} is your Trusted Connection now",
	"TrustedConnection.Label.AddTrustedConnection": "Add Trusted Connection",
	"TrustedConnection.Toast.VisitApp":
		"{displayName} @{userName} sent you a Trusted Connection request. Visit Roblox app to add them back.",
	"TrustedConnection.Toast.TrustedConnectionRequestSent":
		"Trusted Connection request sent",
	Mutual: "Mutual",
	Mutuals: "Mutuals",
	...
	"TrustedFriends.InfoLabel":
		"Only add people you know as Trusted Connections. Manage this Connection anytime from their profile.",
	"TrustedFriend.Info.Modal.Header": "New trusted friend",
	"Message.ViewAndConnectHint.FriendsRename":
		"View friend requests and connect with friends you already know",
	"Label.AddFriendVPC":
		"To add this trusted friend, you need parent permission.",
	...
	"TrustedFriend.Sent.Toast":
		"{displayName} @{userName} sent you a trusted friend request",
	"TrustedFriend.Accept.Toast":
		"{displayName} @{userName} accepted your trusted friend request",
	"TrustedFriend.Accepted.Toast":
		"{displayName} @{userName} is your trusted friend now",
	...
	"TrustedFriend.GenericModal.Description":
		"Only add people you know as trusted friends. Manage this friend anytime from their profile.",
	"TrustedFriend.Info.Modal.Description":
		"Chat without filters, Party voice and more are now unlocked. Manage this friend anytime from their profile.",
	"TrustedFriend.Label.AddTrustedFriend": "Add trusted friend",
	"TrustedFriend.Toast.TrustedFriendRemoved": "Trusted friend removed",
	"Label.AddFriendsHintBody":
		"Connect with friends you already know or discover new ones",
	"TrustedFriend.Toast.TrustedFriendRequestSent": "Trusted friend request sent",
	"TrustedFriend.Toast.VisitApp":
		"{displayName} @{userName} sent you a trusted friend request. Visit Roblox app to add them back.",
	"TrustedFriend.Upsell.Modal.Description":
		"Add people you know as trusted friends to unlock chat without filters, Party voice and more. Manage this friend anytime from their profile.",
	"TrustedFriend.Upsell.Modal.Header": "Chat freely with trusted friends",
	"TrustedFriends.InfoLabel.FriendsRename":
		"Only add people you know as trusted friends. Manage this friend anytime from their profile.",
	...
	"Label.WebMutualFriend":
		"{mutualConnectionsCount, plural, =0 {# mutual friends} =1 {# mutual friend} other {# mutual friends}}",
	"Description.DoMoreWithTrustedFriends":
		"Do more on Roblox with trusted friends. Only add people you know and trust.",
	"Text.IsPlaying": "is playing",
	"Description.DoMoreWithTrustedConnections":
		"Do more on Roblox with Trusted Connections. Only add people you know and trust.",
	"Description.TrustedFriendsUnavailable":
		"The trusted friends feature is not yet available in your region.",
	"Description.TrustedConnectionsUnavailable":
		"The Trusted Connections feature is not yet available in your region.",
	"Title.TrustedFriendsExpiredLink": "Link expired",
	"Description.TrustedFriendsExpiredLink":
		"Please ask your friend to send the link again. Click the link within 30 days.",
	"Title.TrustedFriendsInvalidLink": "Link isn't valid",
	"Description.TrustedFriendsInvalidLink":
		"Make sure you're logged in with the right account, then try again.",
	"Label.NowTrusted": "{username} is now a trusted friend",
	"Action.ShareQR": "Share QR",
	"Description.YouCanDoMoreWithTrustedFriends":
		"You can do more on Roblox with trusted friends. Manage this friend anytime from their profile.",
	...
	"Description.TrustedFriendsRequestModalBody":
...
window.Roblox &&
	...
	window.Roblox.BundleDetector.bundleDetected(
		"DynamicLocalizationResourceScript_Feature.Friends",
	);
