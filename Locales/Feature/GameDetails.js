...
Roblox.LangDynamic["Feature.GameDetails"] = {
	...
	"Label.GenreUnderConstruction":
		"Experience genres are currently under construction and not available. Stay tuned as we design an improved genre system.",
	"Label.GenreUnavailable": "Genre: N/A",
	"Label.GenreInProgress":
		"Currently showing the Roblox-assigned genre for this experience. Stay tuned as we design an improved genre system.",
	...
	"Message.SponsoredDisclosure.Error":
		"The sponsorship information could not be displayed due to a temporary error.",
	...
	"Label.DefaultGameImageAltText":
		"Promotional image #{imageNum} for {placeName}",
	"Label.Badges": "Badges",
...
window.Roblox &&
	...
	window.Roblox.BundleDetector.bundleDetected(
		"DynamicLocalizationResourceScript_Feature.GameDetails",
	);
