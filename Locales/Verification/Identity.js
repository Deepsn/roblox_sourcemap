...
Roblox.LangDynamic["Verification.Identity"] = {
	...
	"Label.FAEModal":
		"Take a selfie to check your age and enjoy features and content appropriate for you.",
	"Label.IDVModal":
		"Use an ID to verify your age and enjoy features and content appropriate for you.",
	"Label.FAEModalDisclaimer":
		"By continuing, you’ll complete an age check process operated by our third party service provider.",
	"Label.IDVModalDisclaimer":
		"By continuing, you’ll complete an ID verification process operated by our third party service provider.",
};
window.Roblox &&
	window.Roblox.BundleDetector &&
	window.Roblox.BundleDetector.bundleDetected(
		"DynamicLocalizationResourceScript_Verification.Identity",
	);
