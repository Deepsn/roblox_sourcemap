// bundle: angular___8b2154b7d188395b7a1c96a036dc4c8b_m // files: angular/angular.min.js, angular/angular-sanitize.min.js, angular/angular-ui-router.min.js, angular/ui-bootstrap-custom-tpls-2.5.0.js, angular/angular.ng-modules.js, angular/angular-elastic.js, ~/viewapp/app.js // angular/angular.min.js
/*
 AngularJS v1.6.3
...
(function (w) {
	...
	function me(a) {
		if (G(a))
			u(a.objectMaxDepth) &&
				(Fc.objectMaxDepth = Tb(a.objectMaxDepth) ? a.objectMaxDepth : NaN);
		else return Fc;
	}
	function Tb(a) {
		return ba(a) && 0 < a;
	...
	function pa(a, b) {
		...
		if (d === typeof b && "object" === d)
			if (H(a)) {
				...
				for (c in b)
					if (!(c in d) && "$" !== c.charAt(0) && u(b[c]) && !E(b[c]))
						return !1;
				return !0;
			}
		return !1;
	...
	function ze() {
		...
		if (!Rc) {
			var b = sb();
			(na = x(b) ? w.jQuery : b ? w[b] : void 0) && na.fn.on
				? ((F = na),
					R(na.fn, {
						scope: Oa.scope,
	...
	function hb(a, b) {
		...
		c &&
			(b
				? delete c.data[b]
				: (c.handle && (c.events.$destroy && c.handle({}, "$destroy"), dd(a)),
					delete ib[d],
					(a.ng339 = void 0)));
	}
	function zb(a, b) {
		...
		this.$get = [
			...
			function (a, b, c, e, n, L, C, z, O, X) {
				...
				function Na(a, b, c, d, e, f) {
					...
					for (
						var h = [], k = H(a) || a instanceof F, l, m, n, q, J, r = 0;
						r < a.length;
						r++
					) {
						l = new s();
				...
				function hc(a, b, c, d, e) {
					...
					switch (a.nodeType) {
						case 1:
							...
							Y(b, Ba(g), "E", d, e);
							for (
								var k, l, m, n, q = a.attributes, J = 0, r = q && q.length;
								J < r;
								J++
							) {
								var B = !1,
				...
				function W(a, b, d, e, f, g, h, k, l) {
					...
					function n(a, e, f, g, l) {
						...
						C &&
							(ca.$$addScopeInfo(
								...
								I,
								!0,
								!(L && (L === C || L === C.$$originalDirective)),
							),
							ca.$$addScopeClass(v, !0),
							(I.$$isolateBindings = C.$$isolateBindings),
							(z = na(e, g, I, I.$$isolateBindings, C)),
						...
						for (z = h.length; q < z; q++)
							(t = h[q]),
								sa(
									...
									v,
									g,
									t.require && U(t.directiveName, t.require, v, O),
									T,
								);
						var Q = e;
					...
					for (
						var q = -Number.MAX_VALUE,
							J = l.newScopeDirective,
							B = l.controllerDirectives,
						...
						if ((w = z.scope))
							z.templateUrl ||
								(G(w)
									? ($("new/isolated scope", C || J, z, y), (C = z))
									: $("new/isolated scope", C, z, y)),
								(J = J || z);
						v = z.name;
						if (
							!u &&
							((z.replace && (z.templateUrl || z.template)) ||
								(z.transclude && !z.$$tlb))
						) {
							for (w = A + 1; (u = a[w++]); )
								if (
						...
						!z.templateUrl &&
							z.controller &&
							((B = B || V()),
							$("'" + v + "' controller", B[v], z, y),
							(B[v] = z));
						if ((w = z.transclude))
							if (
								((I = !0),
								z.$$tlb || ($("transclusion", t, z, y), (t = z)),
								"element" === w)
							)
								(X = !0),
									(q = z.priority),
									(T = y),
									(y = d.$$element = F(ca.$$createComment(v, d[v]))),
									(b = y[0]),
									ka(f, va.call(T, 0), b),
									(T[0].$$parentNode = T[0].parentNode),
									(N = ic(Ma, T, e, q, g && g.name, {
						...
						if (z.template)
							if (
								...
								$("template", L, z, y),
								(L = z),
								(w = E(z.template) ? z.template(y, d) : z.template),
								(w = Ea(w)),
								z.replace)
							) {
								g = z;
						...
						if (z.templateUrl)
							...
							try {
								...
								E(Q)
									? m(null, bb(Z, Q), Na, M)
									: Q && m(bb(Z, Q.pre), bb(Z, Q.post), Na, M);
							} catch (ea) {
								c(ea, xa(y));
							}
								...
								if (!c.$$bindings) {
									...
									G(J.scope) &&
										(!0 === J.bindToController
											? ((B.bindToController = d(J.scope, r, !0)),
												(B.isolateScope = {}))
											: (B.isolateScope = d(J.scope, r, !1)));
									G(J.bindToController) &&
										(B.bindToController = d(J.bindToController, r, !0));
									if (B.bindToController && !J.controller)
										throw fa("noctrl", r);
									m = m.$$bindings = B;
						...
						switch (e.mode) {
							...
							case "=":
								...
								q = e.collection
									...
									: a.$watch(n(c[m], q), null, B.literal);
								k.push(q);
								break;
							case "<":
								if (!ua.call(c, m)) {
				...
				s.prototype = {
					...
					$set: function (a, b, d, e) {
						...
						e
							? (this.$attr[a] = e)
							: (e = this.$attr[a]) || (this.$attr[a] = e = Qc(a, "-"));
						f = wa(this.$$element);
						if (
				...
				return function (f, g, h, k) {
					...
					if (D(f)) {
						...
						f = a.hasOwnProperty(m)
							? a[m]
							: Sc(g.$scope, m, !0) || (b ? Sc(c, m, !0) : void 0);
			...
			function (c, e, f, g, h, k, l, m) {
				...
				function q(c, d) {
					...
					function l(a, c, d, e) {
						...
						O &&
							(200 <= a && 300 > a ? O.put(Q, [a, c, td(d), e]) : O.remove(Q));
					...
					(!c.cache && !a.cache) ||
						...
						(O = G(c.cache) ? c.cache : G(a.cache) ? a.cache : N);
					O &&
						((X = O.get(Q)),
						u(X)
							? X && E(X.then)
								? X.then(J, J)
								: H(X)
									? q(X[1], X[0], qa(X[2]), X[3])
									: q(X, 200, {}, "OK")
							: O.put(Q, z));
					x(X) &&
						((X = wd(c.url)
							? f()[c.xsrfCookieName || a.xsrfCookieName]
							: void 0) && (T[c.xsrfHeaderName || a.xsrfHeaderName] = X),
						e(
							c.method,
							Q,
							d,
			...
			function (a, b, d, c, e) {
				function f(f, k, l, m) {
					...
					v.$$intervalId = I(function () {
						...
						0 < l &&
							t >= l &&
							(y.resolve(t), p(v.$$intervalId), delete g[v.$$intervalId]);
						K || a.$apply();
					}, k);
					g[v.$$intervalId] = y;
					return v;
				...
				f.cancel = function (a) {
					return a && a.$$intervalId in g
						? (g[a.$$intervalId].promise.catch(A),
	...
	function Jf() {
		...
		this.html5Mode = function (a) {
			...
			if (G(a)) {
				...
				if (Ha(a.rewriteLinks) || D(a.rewriteLinks))
	...
	function Fd(a) {
		if (1 === a.body.length && Ed(a.body[0].expression))
			return {
			...
			function (e) {
				function f(a, b, c) {
					return null == a || null == b
						? a === b
						: "object" !== typeof a || c || ((a = rc(a)), "object" !== typeof a)
							? a === b || (a !== a && b !== b)
							: !1;
				}
					...
					if (1 === g.length) {
						...
						return a.$watch(
							function (a) {
								var b = g(a);
								f(b, k, d.literal) ||
									((h = d(a, void 0, void 0, [b])), (k = b && rc(b)));
								return h;
							},
							b,
							c,
				...
				function m(a, b) {
					...
					a.$$watchDelegate && a.$$watchDelegate !== g
						? ((c.$$watchDelegate = a.$$watchDelegate), (c.inputs = a.inputs))
						: b.$stateful ||
							...
							return (
								...
								d ||
									(":" === b.charAt(0) &&
										...
										((f = !0), (b = b.substring(2))),
									(d = new sc(n)),
									(d = new tc(d, e, n).parse(b)),
									d.constant
										? (d.$$watchDelegate = l)
										: f
											? (d.$$watchDelegate = d.literal ? k : h)
			...
			function (f, g, h) {
				...
				m.prototype = {
					...
					$watch: function (a, b, d, e) {
						...
						var h = this,
							k = h.$$watchers,
							l = { fn: b, last: I, get: f, exp: e || a, eq: !!d };
						c = null;
						E(b) || (l.fn = A);
					...
					$digest: function () {
						...
						do {
							...
							if ((r || y.length) && !p--)
								throw ((K.$$phase = null), d("infdig", b, u));
						} while (r || y.length);
						for (K.$$phase = null; B < v.length; )
							try {
								v[B++]();
							} catch (La) {
								f(La);
			...
			function (a, b) {
				var d = {},
					c =
						...
						a.history.pushState,
					e = Z(
						(/android (\d+)/.exec(P((a.navigator || {}).userAgent)) || [])[1],
					),
		...
		function c(a, b) {
			...
			if (d === k) {
				...
				"string" === d
					...
					: "object" === d && (G(k) && (k = a.index), G(l) && (l = b.index));
				k !== l && (c = k < l ? -1 : 1);
			} else c = d < k ? -1 : 1;
			return c;
		}
	...
	eb.$$annotate = function (a, b, d) {
		...
		if ("function" === typeof a) {
			if (!(c = a.$inject)) {
				...
				if (a.length) {
					if (b)
						throw ((D(d) && d) || (d = a.name || ng(a)), ya("strictdi", d));
					b = jd(a);
	...
	var kd = /^((?:x|data)[:\-_])/i,
		...
		tg = /^\)]\}',?\n/,
		xd = M("$http"),
		Da = (ea.$interpolateMinErr = M("$interpolate"));
	...
	Hd.prototype = {
		compile: function (a) {
			...
			d =
				...
				this.watchFns() +
				"return fn;";
			d = new Function("$filter", "getStringValue", "ifDefined", "plus", d)(
				this.$filter,
				zg,
				Ag,
				Cd,
	...
	var le = {
			...
			"datetime-local": pb(
				"datetimelocal",
				ie,
				Ob(ie, "yyyy MM dd HH mm ss sss".split(" ")),
			...
			radio: function (a, b, d, c) {
				...
				b.on("click", function (a) {
					var g;
					b[0].checked &&
						((g = d.value), e && (g = S(g)), c.$setViewValue(g, a && a.type));
				});
				c.$render = function () {
					var a = d.value;
					e && (a = S(a));
			...
			range: function (a, b, d, c, e, f) {
				...
				var s = c.$render;
				c.$render =
					m && u(p.rangeUnderflow) && u(p.rangeOverflow)
						? function () {
								s();
								c.$setViewValue(b.val());
							}
								...
								f
									? (a(f, !0).then(
											...
											function () {
												c.$$destroyed ||
													s !== r ||
													(x(), c.$emit("$includeContentError", f));
											},
										),
				...
				return {
					...
					link: function (b, d, c, e) {
						ma.call(d[0]).match(/SVG/)
							? (d.empty(),
								a(bd(e.template, w.document).childNodes)(
									b,
									function (a) {
										d.append(a);
									},
	...
	Pb.prototype = {
		$$initGetterSetters: function () {
			if (this.$options.getOption("getterSetter")) {
				...
				throw qb("nonassign", this.$$attr.ngModel, xa(this.$$element));
		},
		$render: A,
		$isEmpty: function (a) {
							...
							a.$watchCollection(n, function (f) {
								...
								for (g = 0; g < A; g++)
									if (
										...
										H[g] = { id: D, scope: void 0, clone: void 0 };
										w[D] = !0;
									}
								for (t in m) {
									C = m[t];
								...
								for (g = 0; g < A; g++)
									if (
										((E = f === G ? g : G[g]), (F = f[E]), (C = H[g]), C.scope)
									) {
										t = r;
										do t = t.nextSibling;
				...
				e.writeValue = function (b) {
					...
					e.hasOption(b)
						? (e.removeUnknownOption(),
							...
							Ta(F(a[0].options[a[0].selectedIndex]), !0))
	...
	w.angular.bootstrap
		? w.console && console.log("WARNING: Tried to load angular more than once.")
		: (ze(),
			Ce(ea),
			ea.module(
				"ngLocale",
...
})(window, window.angular); // angular/angular-ui-router.min.js
/**
...
"undefined" != typeof module &&
				...
				return (
					l || o(),
					{
						...
						update: function (a) {
							return a
								? void (r = d.url())
								: void (d.url() !== r && (d.url(r), d.replace()));
						},
						push: function (a, b, e) {
							var f = a.format(b || {});
							null !== f && b && b["#"] && (f += "#" + b["#"]),
			...
			(t.prototype.format = function (a) {
				...
				for (f = 0; f < i; f++) {
					...
					if (k) {
						...
						if (q === !1)
							null != r &&
								(j += R(r) ? o(r, b).join("-") : encodeURIComponent(r)),
								(j += s);
						else if (q === !0) {
							var u = j.match(/\/$/) ? /\/?(.*)/ : /(.*)/;
							j += s.match(u)[1];
	...
	})(window, window.angular); // angular/ui-bootstrap-custom-tpls-2.5.0.js
...
Roblox &&
	...
	Roblox.BundleDetector.bundleDetected("angular");
