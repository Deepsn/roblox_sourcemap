...
Roblox.Lang["PresenceResources"] = Roblox.Lang["Common.Presence"]; // ~/Generated/js/Roblox_TranslationResources_Authentication_LoginResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
Roblox.Lang["Authentication.Login"] = {
	...
	"Description.AccountSelectorHelp":
		"All of your associated accounts are listed here.",
	...
	"Description.EnterOneTimeCodeHelpV3":
		"Enter the code we just sent to you / your parent's email: {email}",
	"Description.EnterParentEmail":
		"Enter your parent's email address to receive a verification code.",
	"Description.GetOneTimeCodeHelp":
		"Enter the email verified on your account to receive a one-time code.",
	"Description.LogBackIn":
		"Your account {display_name} is logged out, please log back in.",
	...
	"Description.LoginOneTimePasscodeEmail.V1.Subject":
		"{code} Is Your Roblox One-Time Code",
	"Description.LoginPageMetaTag":
	...
	"Label.GreetingForNewAccount":
		"Nice to meet you, {username}. {linkStartSignup}Let's make an account! {linkEndSignup}",
	...
	"Label.UnverifiedEmailInstructions":
		"To log in with your email, it must be verified. You can also log in with your username.",
	...
	"Response.EmailLinkedToMultipleAccountsLoginWithUsername":
		"Your email is associated with more than 1 username. Please login with your username.",
	"Response.EmailSent": "Email sent!",
	"Response.ErrorUseCorporateNetwork":
		"You must be on the Corporate network to log in.",
	"Response.FloodCheckError":
	...
	"Response.IncorrectCredentialsForgotPasswordMessage":
		"Your credentials are incorrect. Please double check and try again.",
	"Response.IncorrectEmailOrPassword": "Incorrect email or password.",
	"Response.IncorrectOtpCode":
		"Your code is incorrect. Please double check and try again.",
	...
	"Response.LoginWithUsername":
		"Something went wrong. Please login with your username.",
	"Response.OtpLoginRobloxEmailNetworkError":
		"You must be on the Corporate network to log in.",
	...
	"Response.OtpUnder13NotAllowed":
		"Only users 13 and older can log in with a one-time code.",
	"Response.PasswordNotProvided": "You must enter a password.",
	"Response.SessionExpiredLoginAgain":
		"Your session has expired. Please login again.",
	"Response.TencentSignupDisabled":
		"Sign ups have been disabled. Please try again later.",
	...
	"Response.UnverifiedEmailLoginWithUsername":
		"Your email is not verified. Please login with your username.",
	"Response.UnverifiedPhoneLoginWithUsername":
		"Your phone is not verified. Please login with your username.",
...
Roblox.Lang["LoginResources"] = Roblox.Lang["Authentication.Login"]; // ~/Generated/js/Roblox_TranslationResources_Authentication_OneTimePasscodeResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
Roblox.Lang["Authentication.OneTimePasscode"] = {
	...
	"Action.OverseasPersonalInformationTransfer":
	...
	"Action.ThirdPartyPersonalInformationProvision":
		"third party provision of personal information",
	"Action.TryAnotherWay": "Try another way",
	"Description.ConsentToAllTerms":
		"Consent to all terms, including required and optional terms.",
	"Description.CSChatbotOneTimePasscodeEmail.V1.Subject":
		"Roblox Customer Support One-Time Code",
	...
	"Description.EnterCode":
		"A one-time code was just sent to your email if its is verified on your account. Enter the code we just sent to:",
	"Description.EnterCodeHelp":
		"A one time code was sent to your email if it is verified on your account. Enter the code we sent to:",
	...
	"Description.OneTimePasscodeEmail.V1.Subject":
		"{code} Is Your Roblox One-Time Code",
	"Description.OneTimePasscodeEmail.V2.Subject":
		"{code} Is Your Roblox One-Time Login Code",
	"Description.OptionalPersonalInformationTerms":
		"I consent to the collection and processing of {OptionalPersonalInformationLink}",
	"Description.OverseasPersonalInformationTerms":
		"I consent to the {OverseasPersonalInformationTransferLink}",
	...
	"Description.RequiredPersonalInformationTerms":
		"I consent to the collection and processing of {RequiredPersonalInformationLink}",
	...
	"Description.SendVerificationCode":
		"We'll send your parent a verification code so they can help you sign up",
	"Description.SentEmail": "We've sent an email to",
	"Description.TermsConditionsAndPrivacyPolicy":
		"I’ve reviewed and agree the Terms and Conditions of the User Agreement and acknowledge the Privacy Policy ",
	"Description.ThirdPartyPersonalInformationTerms":
		"I consent to {ThirdPartyPersonalInformationLink}",
	...
	"Description.UserAgreementsTerms":
		"I’ve reviewed and agree the {TermsAndConditionsLink} of the User Agreement and acknowledge the {PrivacyPolicyLink}",
	...
	"Label.RefreshPage":
		"Something went wrong. Please refresh this page to sign up",
	"Label.Required": "Required",
	"Label.SixDigitCode": "6-Digit Code",
	"Response.ChooseAnotherMethod":
		"Please go back to choose another method to log into the following accounts.",
	"Response.Under13NotAllowed":
		"Only users 13 and older can log in with a one-time code.",
};
Roblox.Lang["OneTimePasscodeResources"] =
	Roblox.Lang["Authentication.OneTimePasscode"]; // ~/Generated/js/Roblox_TranslationResources_Authentication_CaptchaResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
Roblox.Lang["Authentication.Captcha"] = {
	...
	"Message.Error.Default":
		"An unknown error occurred while displaying captcha.",
	"Response.CaptchaNotEnteredError": "Please fill out the Captcha",
};
Roblox.Lang["CaptchaResources"] = Roblox.Lang["Authentication.Captcha"]; // ~/Generated/js/Roblox_TranslationResources_Feature_ForceAuthenticatorResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
Roblox.Lang["Feature.ForceAuthenticator"] = {
	"Action.Setup": "Set Up",
	"Description.Reason":
		"2 steps of security will protect your login, Robux, big purchases, experiences and more.",
	"Description.SetupAuthenticator":
		"You must set up 2-Step Verification via Authenticator to complete this action.",
	"Header.TurnOnAuthenticator": "Turn on Authenticator",
};
Roblox.Lang["ForceAuthenticatorResources"] =
	Roblox.Lang["Feature.ForceAuthenticator"]; // ~/Generated/js/Roblox_TranslationResources_Feature_ForceTwoStepVerificationResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
...
Roblox.Lang["ForceTwoStepVerificationResources"] =
	Roblox.Lang["Feature.ForceTwoStepVerification"]; // ~/Generated/js/Roblox_TranslationResources_Feature_ProofOfWorkChallengeResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
...
Roblox.Lang["ProofOfWorkChallengeResources"] =
	Roblox.Lang["Feature.ProofOfWorkChallenge"]; // ~/Generated/js/Roblox_TranslationResources_Feature_ReauthenticationResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
Roblox.Lang["Feature.Reauthentication"] = {
	...
	"Description.EnterYourOtpCode":
		"A one-time code has been sent to your registered email.{lineBreak}Please enter your one-time code to continue.",
	...
	"Label.PasskeyDirections":
		"Your device will ask for your fingerprint, face ID, or screen lock.",
	"Label.Password": "Password",
	...
	"Message.Error.NoCredentialsFound":
		"Something went wrong. Try changing a verification method.",
	...
	"Message.Error.OtpCodeThrottled":
		"You've sent too many codes! Please wait a few minutes before trying again!",
...
Roblox.Lang["ReauthenticationResources"] =
	Roblox.Lang["Feature.Reauthentication"]; // ~/Generated/js/Roblox_TranslationResources_Feature_RostileChallengeResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
Roblox.Lang["Feature.RostileChallenge"] = {
	...
	"Description.VerificationError":
		"Verification failed because of an issue. Please try again.",
...
Roblox.Lang["RostileChallengeResources"] =
	Roblox.Lang["Feature.RostileChallenge"]; // ~/Generated/js/Roblox_TranslationResources_Feature_SecurityQuestionsResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
Roblox.Lang["Feature.SecurityQuestions"] = {
	...
	"Description.RegainAccess":
		"To regain access to your account, please contact Roblox Customer Support {linkStart}here{linkEnd}.",
	"Description.RegainAccessGeneric":
		"To regain access to your account, please click {styledLinkText}.",
	...
	"Description.WhichGames":
		"Which of these experiences have you joined in the last {days} days?",
	"Description.YourPasswordHasBeenReset":
		"To protect your account, your password has been reset.",
...
Roblox.Lang["SecurityQuestionsResources"] =
	Roblox.Lang["Feature.SecurityQuestions"]; // ~/Generated/js/Roblox_TranslationResources_Feature_PrivateAccessTokenChallengeResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
...
Roblox.Lang["PrivateAccessTokenChallengeResources"] =
	Roblox.Lang["Feature.PrivateAccessTokenChallenge"]; // ~/Generated/js/Roblox_TranslationResources_Feature_DeviceIntegrityChallengeResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
...
Roblox.Lang["DeviceIntegrityChallengeResources"] =
	Roblox.Lang["Feature.DeviceIntegrityChallenge"]; // ~/Generated/js/Roblox_TranslationResources_Feature_VerificationUpsellResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
Roblox.Lang["Feature.VerificationUpsell"] = {
	...
	"Action.Verify": "Verify",
	"Description.AddEmailTextOver13":
		"To continue with your purchase, please add your email address.",
	...
	"Description.AddEmailTextUnder13":
		"To continue with your purchase, please have your parent add their email address.",
	...
	"Description.CanNowJoinVoice":
		"You can now join a Voice Chat enabled experience to start having fun.",
	"Description.CanNowTalk":
		"You can now talk to others on Roblox as naturally as you do in the physical world.",
	"Description.CanUsePhoneForRecovery":
		"You can now use your phone number to recover your account in the future.",
	...
	"Description.LogoutAddEmailTextOver13":
		"Before logging out, please add your email address so that you don't get locked out.",
	"Description.LogoutAddEmailTextUnder13":
		"Before logging out, please add your parent's email address so that you don't get locked out.",
	...
	"Description.PhoneForRecovery":
		"You can now use your phone number to recover your account in the future.",
	"Description.PhoneNumberNeverPublic":
		"Your phone number will never be displayed publicly.",
	"Description.PleaseEnterEmail":
		"Please enter an email address to add to your account.",
	"Description.PleaseEnterEmailUnder13":
		"Please enter your parent's email address to add to your account.",
	...
	"Description.TurnOnVoiceChat":
		"Turn on Voice Chat in Settings > Privacy > Microphone and Camera Input.",
	"Description.VerificationCodeSmsFeesMayApply":
		"You will receive a one-time verification code via WhatsApp or SMS. Message and data rates may apply.",
	"Description.VerifyEmailBody":
		"Please click the link in the confirmation email we sent to {emailAddress}.",
	...
	"Heading.VoiceChatEnabledMobile":
		"Voice Chat enabled! Try now in an experience.",
	"Heading.VoiceChatError":
		"Phone added! Turn on Voice Chat in Settings > Privacy > Microphone and Camera Input.",
	"Label.ConnectWithRealLifeFriends":
		"Connect with your real life friends via phone number (opt-in only).",
	...
	"Label.RecoverIfPasswordLost":
		"Recover your account in case you lose your password.",
	"Label.SixDigitCode": "6-Digit Code",
	"Label.VerifyPhoneNumber": "Verify Phone Number",
	"Label.Yes": "Yes",
	"Message.Confirmation":
		"We'll text your verification code to {phoneNumber}. SMS fees may apply.",
	"Message.ConfirmationEmailNotSent":
		"Confirmation email not sent. Please try again later.",
	...
	"Response.ErrorPhoneFormatInvalid":
		"This phone number format is invalid. Please check and try again.",
	"Response.ErrorTryAgain": "Something went wrong. Please try again later.",
	"Response.InvalidPhoneNumberError":
	...
	"Response.PhoneNumberAlreadyLinked":
		"This number has already been associated with another account.",
	"Response.TooManyAttemptsTryAgainLater":
		"Too many attempts. Please try again later.",
	"Response.TooManyVerificationAttemps":
		"Too many attempts. Please try again in a few minutes.",
	"Response.TooManyVerificationAttempts":
		"Too many attempts. Please try again in a few minutes.",
};
Roblox.Lang["VerificationUpsellResources"] =
	Roblox.Lang["Feature.VerificationUpsell"]; // ~/Generated/js/Roblox_TranslationResources_Feature_AccountSettingsResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
...
Roblox.Lang["AccountSettingsResources"] =
	Roblox.Lang["Feature.AccountSettings"]; // ~/Generated/js/Roblox_TranslationResources_Authentication_AccountSwitchResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
Roblox.Lang["Authentication.AccountSwitch"] = {
	...
	"Description.AccountLimit":
		"To add another account, you’ll first need to log out of one.",
	"Description.AccountSwitchingNotWorking":
		"Account switching is not working. Try again later",
	"Description.InvalidAccountSwitch":
		"This account cannot be switched to. Try log in directly.",
	"Description.LogoutAllBody":
		"To protect your account security, you will be logged out of all the accounts. You may log back in at any time.",
	"Description.LogoutConfirmation":
		"You’ll need to log out of your other Roblox accounts on this device before adding a new account",
	"Description.ParentLogoutConfirmation":
		"You’ll need to log out of your other Roblox accounts on this device before adding a new account with parent privileges",
	"Description.ParentLogoutConfirmation.2":
		"Please log out of all other Roblox accounts on this device before adding a new account with parent privileges",
	...
	"Label.AccountLimitReached":
		"You’ve added 5 accounts. To add another account, you’ll first need to log out of one.",
	"Label.AccountLimitReached.2": "To add an account, log out of one first.",
	"Label.AddAccountWithoutLoggingOut":
		"You can add a new account without logging out.",
	"Label.AddOrSwitchAccount":
		"You can switch to another account or add a new account without logging out.",
	"Label.ChooseAccountToUse": "Choose a new account to use",
	"Label.LoggedOutAddOrSwitchAccount":
		"Switch to another account, or add a new account.",
};
Roblox.Lang["AccountSwitchResources"] =
	Roblox.Lang["Authentication.AccountSwitch"]; // ~/Generated/js/Roblox_TranslationResources_CommonUI_ControlsResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
...
Roblox.Lang["ControlsResources"] = Roblox.Lang["CommonUI.Controls"]; // ~/Generated/js/Roblox_TranslationResources_Feature_RecommendationsResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
...
Roblox.Lang["RecommendationsResources"] =
	Roblox.Lang["Feature.Recommendations"]; // ~/Generated/js/Roblox_TranslationResources_CommonUI_FeaturesResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
...
Roblox.Lang["FeaturesResources"] = Roblox.Lang["CommonUI.Features"]; // ~/Generated/js/Roblox_TranslationResources_Feature_ProfileBadgesResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
...
Roblox.Lang["ProfileBadgesResources"] = Roblox.Lang["Feature.ProfileBadges"]; // ~/Generated/js/Roblox_TranslationResources_CommonUI_MessagesResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
Roblox.Lang["CommonUI.Messages"] = {
	...
	"Description.ErrorPageCheckStatus":
		"If you continue to receive this message, check out {startLink}our status{endLink}.",
	"Label.Error": "Error",
	...
	"Message.CDRedirection":
		"This page has been migrated to the Creator Dashboard. You can use the updated page by clicking.",
	"Message.CDRedirectionLinkText": "[here]",
	"Message.CDRedirectionMessage":
		"This page has been migrated to the Creator Dashboard. You can use the updated page by clicking {linkText}.",
	...
	"Message.ErrorGeneral":
		"Something went wrong. Please check back in a few minutes.",
	...
	"Response.UnsafeInput":
		"You are not allowed to use HTML characters such as <b> in forms on the website.",
	"Title.UnsafeInput": "Unsafe Input",
};
Roblox.Lang["MessagesResources"] = Roblox.Lang["CommonUI.Messages"]; // ~/Generated/js/Roblox_TranslationResources_Common_AlertsAndOptionsResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
Roblox.Lang["Common.AlertsAndOptions"] = {
	"Action.OK": "OK",
	"Action.SkipToMainContent": "Skip to Main Content",
	"Description.AccountSwitchedConfirmationBannerText":
		"You switched to {accountName}",
...
Roblox.Lang["Feature.ShopDialog"] = {
	...
	"Description.AmazonRedirect":
		"Your are about to visit our amazon store. You will be redirected to Roblox merchandise store on {shopLink}.",
	"Description.PurchaseAgeWarning":
		"Please note that you need to be over 18 to purchase products online. We hope to see you again soon!",
...
Roblox.Lang["ShopDialogResources"] = Roblox.Lang["Feature.ShopDialog"]; // ~/Generated/js/Roblox_TranslationResources_Purchasing_RedeemGameCardResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
Roblox.Lang["Purchasing.RedeemGameCard"] = {
	...
	"Action.RedeemGiftCardInstructions":
		"Enter a virtual item or gift card code below.",
	"Action.RedeemGiftCardOrItemOrPromoCodeInstructions":
		"Enter your gift card, virtual item, or promo code below.",
	"Action.RedeemGiftCardOrPromoCodeInstructions":
		"Enter a virtual item, gift card or promo code below.",
	...
	"Alert.RobuxPackagePurchaseFailed":
		"Something went wrong! Unable to purchase the product. Please try again later.\t",
	"Alert.SuccessfullyConvertedCreditToRobux":
		"Remaining credit successfully converted to Robux",
	"Description.CombineCards": "Combine cards for more Roblox credit.",
	"Description.CreditConversion":
		"You are redeeming a code for {cardValue}. The amount will be converted to local currency ({localCurrencyCode}).",
	...
	"Description.Dialog.RobloxRedeemCard":
		"You must be logged in to your Roblox account to redeem your Gift Card!",
	"Description.EnterGiftCardPin":
		"Enter your gift card PIN, and then select Redeem.",
	"Description.FindInInventory":
		"If your gift card comes with a virtual item, you can find it in your {inventoryLinkStart}Inventory{inventoryLinkEnd}.",
	...
	"Description.LegalDisclaimer":
		"Purchases can be made with only one form of payment. Gift card credits cannot be combined with other forms of payment.",
	...
	"Description.RetailersInfo":
		"Buy a Roblox gift card at one of the participating retailers or receive a Roblox gift card from someone.",
	"Description.RobuxAdded":
		"{robuxRedeemedAmount} will be added to your balance.",
	"Description.RobuxAddedEnd": "will be added to your balance.",
	"Description.SendAnotherGift":
		"Want to send another gift card? Visit {giftcardLinkStart}roblox.com/giftcards{giftcardLinkEnd} for details.",
	"Description.SpendRobloxCredit":
		"Spend your Roblox credit on Robux and Builders Club!",
	...
	"Heading.ConvertSuccess":
		"Success! Credit was converted to Robux and added to your balance.",
	"Heading.ConvertToRobux": "Convert To Robux",
	"Heading.CreditConversion": "Credit Conversion",
	"Heading.CreditConversionFail":
		"Something went wrong! Unable to convert credit to Robux. Please try again later.",
	"Heading.CreditConversionSuccess":
		"Success! Credit was converted to Robux and added to your balance.",
	...
	"Heading.LocalCreditBanner":
		"NOTICE: Upcoming Change to Redemption Rate for Roblox Credit (Local Currency)",
	"Heading.LocalCreditPreLaunchWarning":
		"In April 2023 the Roblox credit in your account will be automatically converted to your local currency.",
	...
	"Label.HowToRedeemBonusItem":
		"{redeemBonusItemLinkStart}How to Redeem Virtual Item Codes{redeemBonusItemLinkEnd}",
	"Label.HowToRedeemGiftCard":
		"{redeemGiftCardLinkStart}How to Redeem Gift Cards{redeemGiftCardLinkStart}",
	"Label.HowToRedeemGiftCardLink":
		"{redeemGiftCardLinkStart}How to Redeem Gift Cards{redeemGiftCardLinkEnd}",
	"Label.HowToRedeemGiftCards": "How to Redeem Gift Cards",
	"Label.HowToRedeemGiftCardVideo":
		"{redeemGiftCardVideoLinkStart} How to Redeem Gift Cards (Video) {redeemGiftCardVideoLinkEnd}",
	"Label.HowToRedeemGiftCardVideoText": "How to Redeem Gift Cards (Video)",
	"Label.HowToRedeemPromoCodeLink":
		"{redeemPromoCodeLinkStart}How to Redeem Promo Codes{redeemPromoCodeLinkEnd}",
	...
	"Label.MoreHelpOnGiftCardsLink":
		"{moreGiftCardHelpLinkStart} More Help on Gift Cards {moreGiftCardHelpLinkEnd}",
	...
	"Label.RedeemItHere":
		"{redeemHereLinkStart}Redeem it here.{redeemHereLinkEnd}",
	...
	"Message.CaptchaCannotVerify":
		"We currently cannot verify FunCaptcha, please try again later.",
	"Message.CodeNotYetRedeemed":
		"The gift card code was not redeemed. Please keep your card for future redemption.",
	"Message.ConvertCreditToRobux":
	...
	"Message.Step2NextLargestPackage":
	...
	"Response.AlreadyRedeemedCodeFullError":
		"This code has already been redeemed. Your credit balance will be updated shortly.",
	"Response.AlreadyRedeemedError": "This gift card has already been redeemed.",
	"Response.BonusPreview":
		"Redeem one more Roblox card from GameStop to receive your bonus Robux.",
	"Response.BuildersClubExtended":
		"Your Builders Club Membership has successfully been extended!",
	"Response.BuildersClubExtendedSubText":
		"Please allow up to 5 minutes for the changes to take effect.",
	"Response.BuildersClubRedeemed":
		"Your Builders Club Membership has successfully been redeemed!",
	...
	"Response.GiftCardCurrencyNotMatch":
		"The currency of your Gift card must match your account country.",
	...
	"Response.MerchantNotFoundError":
		"User tried to redeem Pin but the merchant does not exist. UserId: {authenticatedUserId} Pin Number: {cardPin}",
	...
	"Response.ObjectNotFoundError":
		"Could not find the requested object. Please try your request again and contact customer service if this problem persists.",
	...
	"Response.RedeemSuccessForProduct":
		"You have successfully redeemed your card for {productName}",
	...
	"Response.TooManyCodesRedeemedError":
		"Too many codes redeemed. Try your request again later.",
	"Response.TooManyRequestsError":
		"Too many failed request attempts. Try your request again later.",
	"Response.TwoCardsBonus":
		"Thanks for redeeming two Roblox cards from GameStop. {robuxCount} Robux have been added to your account.",
	"Response.UnexpectedError":
		"An unexpected error occurred. Please try your request again later.",
	"Response.WalmartRewardUpsell":
		"Redeem one more Roblox card from Walmart to receive {rewardName}.",
};
Roblox.Lang["RedeemGameCardResources"] =
	Roblox.Lang["Purchasing.RedeemGameCard"]; // ~/Generated/js/Roblox_TranslationResources_Feature_NotApprovedResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
Roblox.Lang["Feature.NotApproved"] = {
	...
	"Description.Appeal":
		"If you wish to appeal, please contact us via the {startLink}Support Form{endLink}.",
	"Description.AppealsProcess":
		"To learn more about the appeals process, visit {startLink}Appeal Your Content Moderation{endLink}.",
	...
	"Description.AutomatedDetectionManualDecision":
		"This policy violation was detected by automated means",
	"Description.Ban":
		"Your account has been disabled. You may re-activate it after {date}.",
	"Description.CommunityGuidelines":
		"Please abide by the {startLink}Roblox Community Guidelines{endLink} so that Roblox can be fun for users of all ages.",
	"Description.Delete": "Your account has been terminated.",
	"Description.ManualDetectionAutomatedDecision":
	...
	"Description.Poison":
		"Your account has been terminated, and new account creation has been disabled.",
	"Description.ReactivateAccount":
		"You may re-activate your account by agreeing to our {startLink}Terms of Use{endLink}.",
	"Description.Violation":
		"Our content monitors have determined that your behavior at Roblox has been in violation of our {startLink}Terms of Use{endLink}.",
	...
	"Label.AbuseType.Advertising.Note":
		"Roblox does not allow this type of advertisement. Please ensure your ad content complies with the Roblox Advertising Standards.",
	...
	"Label.AbuseType.Chargeback.Note":
		"Your account was suspended for unauthorized charges.",
	"Label.AbuseType.CheatandExploits": "Cheat and Exploits",
	"Label.AbuseType.CheatandExploits.GameEngine.Note":
		"Roblox does not permit the use of third-party software to modify the client.",
	"Label.AbuseType.CheatandExploits.Note":
		"Roblox does not permit users to deploy or discuss any method of cheating on platform.",
	...
	"Label.AbuseType.ContestsandSweepstakes.Note":
		"Roblox does not permit contests or sweepstakes in the form of lottery style games or playing for free Robux.",
	...
	"Label.AbuseType.DatingandRomanticContent.Note":
		"Roblox does not permit dating or romantic exchanges between avatars.",
	...
	"Label.AbuseType.DiscriminatoryorNaziContent":
		"Discriminatory or Nazi Content",
	"Label.AbuseType.DisruptiveAudio": "Disruptive Audio",
	"Label.AbuseType.DisruptiveAudio.Note":
	...
	"Label.AbuseType.EncouragingDangerousBehavior":
		"Encouraging Dangerous Behavior",
	"Label.AbuseType.ExplicitNudityPorn": "Explicit Nudity/Porn",
	"Label.AbuseType.ExplicitSexualReferencesandInnuendo":
	...
	"Label.AbuseType.ExtortionandBlackmail.Note":
		"Roblox does not permit attempts to threaten users in order to force them to do something they do not want to do. ",
	"Label.AbuseType.GangImages": "Gang Images",
	"Label.AbuseType.Grooming": "Grooming",
	"Label.AbuseType.Harassment": "Harassment",
	"Label.AbuseType.Harassment.Note":
		"Roblox does not permit bullying or harassment towards community members.",
	...
	"Label.AbuseType.IllegalandRegulatedContent.Note":
		"Roblox does not permit illegal or regulated content in any form. This can include alcohol, drugs, tobacco products, or bomb or weapon making.",
	"Label.AbuseType.IllicitSubstance": "Illicit Substance",
	"Label.AbuseType.Impersonation": "Impersonation",
	"Label.AbuseType.Impersonation.Note":
		"Roblox does not permit users to mislead others by impersonating other people’s real- or virtual-world identity or affiliations.",
	...
	"Label.AbuseType.MisusingRobloxSystems.Note":
		"Roblox does not permit bypasses of our systems that keep our platform and community safe and secure.",
	...
	"Label.AbuseType.OffPlatformSpeechandBehavior":
		"Off Platform Speech and Behavior",
	"Label.AbuseType.OffPlatformSpeechandBehavior.Note":
		"Roblox may moderate reported users with off-platform behavior associated with organized crime, terrorist groups, hate groups, sharing others' Personal Identifiable Information, including making false reports about users. ",
	"Label.AbuseType.OffSiteLinks": "Off-Site Links",
	"Label.AbuseType.Other": "Other",
	"Label.AbuseType.PersonalAttackHarassmentBullying":
	...
	"Label.AbuseType.PoliticalContent.Note":
		"Roblox does not permit support for current political candidates, parties, associated flags or symbols.",
	...
	"Label.AbuseType.PrivacyAskingforPII.Note":
		"Roblox does not permit the exchange of Personal Identifiable Information (PII) between community members.",
	"Label.AbuseType.PrivacyGivingPII": "Privacy: Giving PII",
	"Label.AbuseType.PrivacyGivingPII.Note":
		"Roblox does not permit sharing Personal Identifiable Information in the form of full name, email address, passwords, physical address, telephone numbers, images of themselves, or unauthorized voice recordings of minors.",
	"Label.AbuseType.Profanity": "Profanity",
	"Label.AbuseType.Profanity.Note":
		"Roblox does not permit profane language or slurs.",
	"Label.AbuseType.RealInfo": "Real Info",
	"Label.AbuseType.RealLifeThreats": "Real-Life Threats",
	"Label.AbuseType.RealLifeThreats.Note":
		"Roblox does not permit real threats of violence towards members of the Roblox Community.",
	"Label.AbuseType.RealLifeTragedy": "Real-Life Tragedy",
	"Label.AbuseType.RealLifeTragedy.Note":
		"Roblox does not permit content that recreates, mocks, or capitalizes off of specific real-world tragic events.",
	...
	"Label.AbuseType.RobloxEconomy.Note":
	...
	"Label.AbuseType.Scamming.Note":
		"Roblox does not permit phishing or scamming links, requests for passwords, selling of accounts, uploading of unauthorized accounts, selling Roblox assets for real money off platform, or artificially inflating numbers associated with experiences.",
	...
	"Label.AbuseType.SexualContent.Note":
		"Roblox does not permit sexual content in any form on the platform.",
	"Label.AbuseType.Shock": "Shock",
	"Label.AbuseType.Spam": "Spam",
	"Label.AbuseType.Spam.Note":
		"Roblox does not permit spamming in the form of clickbait, or repetitive, large volume messaging.",
	"Label.AbuseType.SuggestiveSexualizedImagery":
	...
	"Label.AbuseType.TerrorismExtremism.Note":
		"Roblox does not permit associations with terrorism or violent extremism.",
	...
	"Label.AbuseType.ThreatsorAbuseofRobloxEmployeesorAffiliates.Note":
	...
	"Label.AbuseType.Trademark.Note":
	...
	"Label.EmailVerificationNotice":
		"Your account was suspended for unauthorized charges. You must verify your email address to unlock your account.",
	"Label.Evidence.VoiceRecording":
		"Voice chat conversation on {date} at {time} in {experienceName}",
	...
	"Label.OffensiveItem.AltConsequence":
		"Determined from your account information, such as your account email, phone number, or other information",
	...
	"Label.ParentReactivationNoticeUA":
		"Your parent or legal guardian must help you re-activate this account.",
...
Roblox.Lang["NotApprovedResources"] = Roblox.Lang["Feature.NotApproved"]; // ~/Generated/js/Roblox_TranslationResources_Authentication_PasskeyResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
...
Roblox.Lang["PasskeyResources"] = Roblox.Lang["Authentication.Passkey"]; // ~/Generated/js/Roblox_TranslationResources_Feature_TrackingResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
Roblox.Lang["Feature.Tracking"] = {
	...
	"Description.RBXIDCHECK":
		"Cookie that allows for bypassing 2 factor authentication on this browser",
	"Description.RBXImageCache": "Authentication",
	"Description.RbxIp2": "Security: Floodchecking cookie",
	"Description.RBXSource":
		"Analytics: for user acquisition and ad/source attribution",
	"Description.RBXViralAcquisition":
		"Analytics: For acquisition of users from social media links",
...
Roblox.Lang["TrackingResources"] = Roblox.Lang["Feature.Tracking"]; // ~/Generated/js/Roblox_TranslationResources_Feature_IdVerificationResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
Roblox.Lang["Feature.IdVerification"] = {
	...
	"Description.AgreeTofSAndPP":
		"The {termsOfUseLink} including the arbitration clause and acknowledging the {privacyPolicyLink}",
	"Description.ChooseIdentityOptions":
		"Please select one of the following ways to verify your identity:",
	...
	"Description.ParentChooseIdentityOptions":
		"Please have your parent choose from one of the following options:",
	"Description.ParentChooseOption":
		"Please have your parent choose from one of the following options:",
	"Description.PersonalInfoForUser":
		"If you are signing up to Roblox on behalf of someone else, please use their birthday and gender below.",
	"Description.PIICollection":
		"Consent to the {collectionProcessingPII} of personal information",
	"Description.PIITransfer": "Consent to the {transferPII} overseas",
	"Description.PrivacyPolicy": "Privacy Policy",
	"Description.TermsOfUse": "Terms of Use",
	"Description.VerificationNotComplete":
		"The system failed to verify your ID. Please try again",
	"Description.VerificationRequired":
		"Before continuing, please verify your identity",
	"Heading.AgreeTerms": "Please agree to all of the following:",
	"Heading.IDVerification": "ID Verification",
	"Heading.LeavingRoblox": "You are leaving Roblox",
	"Heading.ParentalConsentAgreement":
		"I am the parent or legal guardian of the proposed user and agree to the following:",
	...
	"Label.AgreeTerms":
		"Agree to the Terms of Use and acknowledge the Privacy Policy",
	"Label.AgreeTermsWithLink":
		"Agree to the {termsOfUseLink} and acknowledge the {privacyPolicyLink}",
...
Roblox.Lang["IdVerificationResources"] = Roblox.Lang["Feature.IdVerification"]; // ~/Generated/js/Roblox_TranslationResources_Feature_AgeVerificationUpsellResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
...
Roblox.Lang["AgeVerificationUpsellResources"] =
	Roblox.Lang["Feature.AgeVerificationUpsell"]; // ~/Generated/js/Roblox_TranslationResources_Feature_ParentsResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
Roblox.Lang["Feature.Parents"] = {
	...
	"Description.AutoUnlink":
		"Once your child reaches the age of majority, your accounts will automatically unlink. ",
	...
	"Description.EmailSent":
		"We’ve sent an email to {parentEmail} with next steps",
	...
	"Description.ExistingParentButNotLinkedActionToRespond":
		"To approve this request, you’ll need to link your Roblox accounts.",
	"Description.ExitEnterEmail":
		"If you do not enter an email, your child's account will remain locked. ",
	"Description.GraduationApproachingEmailSubject":
		"Important update to your parent account on Roblox",
	"Description.GraduationApproachingEmailTopBodyText":
		"Your account will unlink from {childUsername} soon",
	...
	"Description.GraduationApproachingMessageSubjectPlural":
		"Your account will unlink from your parents soon",
	"Description.GraduationApproachingMessageSubjectSingular":
		"Your account will unlink from your parent soon",
	"Description.GraduationEmailFooter":
		"Please do not reply to this message as it will not be delivered to the originator.",
	...
	"Description.GraduationEmailSubject":
		"Your child is no longer linked to your Roblox account",
	"Description.GraduationEmailTopBodyText":
		"Your account is unlinked from {childUsername}",
	...
	"Description.GraduationMessageSubjectPlural":
		"Your account will unlink from your parents today",
	"Description.GraduationMessageSubjectSingular":
		"Your account will unlink from your parent today",
	...
	"Description.LinToChild":
		"You can approve certain actions for your child after linking your accounts",
	"Description.LogOut":
		"To link an existing account, log out of your current session and log back in.",
	"Description.LogOutSignup":
		"To create a new account, first log out of your current session.",
	...
	"Description.NewParentActionToRespond":
		"To approve this request, you’ll need a Roblox account with parent privileges.",
	...
	"Description.ParentAccountSetupEmailFooterText":
	...
	"Description.ParentAccountSetupEmailLinksV2":
		"{aTagWithHref}{learnMorePageLink}{hrefEnd}Learn More{htmlCloseAHref} | {aTagWithHref}{accountSafetyPageLink}{hrefEnd}Account Safety{htmlCloseAHref} | {aTagWithHref}{supportPageLink}{hrefEnd}Support{htmlCloseAHref}",
	"Description.ParentAccountSetupEmailSubject":
		"Your child needs your permission on Roblox",
	...
	"Description.ProcessingVerification":
		"We are processing your ID verification. Please do not close this window until the verification process is complete.",
	"Description.RequestExpired":
		"Open Roblox on your child’s device and re-enter your email to start again",
	"Description.RestartSession":
		"To restart the process and complete your child’s request, re-enter your email on your child’s device. ",
	...
	"Description.UpdateBirthdateEmailSubject":
		"Review your child’s request to update their birthday",
	"Description.UpdateBirthdateRequest":
		"Your child, {childUsername}, would like to update their birthday.",
	...
	"Message.ChildCanUnlock":
		"Your child can now unlock their account from their own device ",
	"Message.EmailIneligible":
		"This email isn’t eligible. To request parent permission on Roblox, use a different email.",
	"Message.ExistAccountWithEmail":
		"Your parent already has an account for approving requests. Enter your parent’s email, instead.",
	"Message.ExitChargebackConsent":
		"Your child won’t be able to use Roblox while their account is locked",
	"Message.ExitMessage": "Continue to complete your child's request",
	"Message.ExitSavePaymentMethodsConsent":
		"Your child won't be able to save a payment method",
	"Message.InvalidEmail": "Invalid email address",
	"Message.LinkExitWarning":
		"You won’t be able to access parental controls and insights about your child if you don’t link accounts",
...
Roblox.Lang["IdentityResources"] = Roblox.Lang["Verification.Identity"]; // ~/Generated/js/Roblox_TranslationResources_Feature_GameBadgesResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
...
Roblox.Lang["GameBadgesResources"] = Roblox.Lang["Feature.GameBadges"]; // ~/Generated/js/Roblox_TranslationResources_Feature_PremiumResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
Roblox.Lang["Feature.Premium"] = {
	...
	"Description.AbilityToSellAndEarnFromAvatar":
		"Ability to sell and earn from your avatar creations on Marketplace*",
	"Description.AccessPremiumGame": "Access Premium benefits within experiences",
	"Description.AccessPremiumItems":
		"Access exclusive Avatar Shop items and discounts",
	"Description.AnnualPremiumComparison": "compared to {price}",
	"Description.AnnualPremiumGetRobuxEachMonth":
		"Pay annually. Get {Robux} monthly",
	"Description.AnnualPremiumSaving": "Save {saving}% with Annual Premium",
	"Description.AnnualPremiumSavingOverMonthly":
		"Save {saving}% compared to monthly plan",
	...
	"Description.BuyRobuxSubtitleV2":
	...
	"Description.GetAccessToAvatarShop":
		"Get access to Premium-only items and special discounts in the {linkStart}Avatar shop{linkEnd}",
	"Description.GetAccessToCatalogItems":
		"Get access to Premium-only items and discounts in the {linkStart}Catalog{linkEnd}",
	"Description.GetAccessToGame":
		"Get access to Premium-only levels, items, boosters, and more!",
	...
	"Description.LegalDisclosureAmount":
		"Amount charged may vary based on payment provider, currency and local taxes.",
	...
	"Description.OnlyAvailableWithRobloxPremium":
		"*Only available with Roblox Premium 1000 or Roblox Premium 2200",
	"Description.PremiumGamesLink": "Explore popular among Premium experiences",
	"Description.PremiumSubscriber":
		"As a Premium subscriber, you get 10% more Robux every time you buy a Robux package.",
	"Description.PremiumSubscriberEx":
		"As a Premium subscriber, you get more Robux every time you buy a Robux package.\t",
	...
	"Description.ReceiveRobuxMonthly":
		"Receive Robux monthly on your subscription renewal date",
	...
	"Description.RobuxPackages":
		"Immediately add Robux to your account when you purchase a package. {linkStart}Learn more about Robux here{linkEnd}.",
	...
	"Description.SellMoreItems":
		"Resell items and get more Robux selling your creations",
	...
	"Heading.PremiumRobuxDiscounts":
		"As a Premium user, you get discounts on Robux!",
	...
	"Label.MembershipManagementRecurring":
		"To manage your Premium subscription, please go to your Billing settings using a browser.",
	"Label.MembershipRepurchase":
		"You can repurchase or buy a new plan once your membership expires.",
	"Label.MembershipStatus":
		"Your current plan is {premiumSubscription}. It will expire on {expirationDate}.",
	...
	"Label.MembershipStatusRecurring":
		"Your current plan is {premiumSubscription}. It will renew on {renewal}.",
	...
	"Label.SubscribeUpsell":
		"Subscribe {upsellLinkStart}and get more!{upsellLinkEnd}",
	"Label.Trade": "Trade",
	...
	"Message.ServerError":
		"A server error occurred while updating your subscription. Please try again later.",
	...
	"Message.UnableToFindBc":
		"Cannot find Builders Club information for this user.",
...
Roblox.Lang["PremiumResources"] = Roblox.Lang["Feature.Premium"]; // ~/Generated/js/Roblox_TranslationResources_Feature_ItemModelResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
Roblox.Lang["Feature.ItemModel"] = {
	...
	"Label.QuantityLimitReached":
		"Creator Limit Reached. The creator has limits on how many copies a single user can purchase from them.",
...
Roblox.Lang["ItemModelResources"] = Roblox.Lang["Feature.ItemModel"]; // ~/Generated/js/Roblox_TranslationResources_Feature_ServerListResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
Roblox.Lang["Feature.ServerList"] = {
	...
	"Label.CurrentPlayerCount":
		"{currentPlayers} of {maximumAllowedPlayers} people max",
	"Label.ExcludeFullServers": "Exclude Full Servers",
	"Label.FriendInServer": "Friends in this server: {friend}",
	"Label.Inactive": "Inactive.",
	"Label.InsufficientFunds":
		"This server has been deactivated. We were not able to process the recurring payment due to insufficient funds in your account.",
	"Label.ManyFriendsInThisServer":
		"Friends in this server: {firstFriend}, {secondFriend}, and  {numOtherFriends, plural, =1 {# other} other {# others}}.",
	...
	"Label.TwoFriendsInServer":
		"Friends in this server: {firstFriend} and {secondFriend}",
...
Roblox.Lang["ServerListResources"] = Roblox.Lang["Feature.ServerList"]; // ~/Generated/js/Roblox_TranslationResources_Feature_VIPServerResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
Roblox.Lang["Feature.VIPServer"] = {
	...
	"Action.SeeAll": "See All",
	"Description.MaxFreePrivateServers":
		"You have created the maximum number of free private servers for this experience.",
	"Description.MaxFreeVipServers":
		"You have created the maximum number of free VIP servers for this experience.",
	"Description.MaxVIPServers":
		"You have created the maximum number of VIP servers for this experience.",
	...
	"Description.SubscriptionStatusDisabled":
		"You will be able to renew your private server subscription after it expires on {expirationDate}.",
	...
	"Label.AddPlayerPrivacyError":
		"You may not invite this user due to their privacy settings.",
	...
	"Label.ChangeFriendsAllowedError.FriendsRename":
		"Unable to change friends allowed.",
	"Label.ChangeFriendsAllowedSuccess":
		"Successfully changed connections allowed.",
	"Label.ChangeFriendsAllowedSuccess.FriendsRename":
	...
	"Label.ChangePrivateServerNamePlaceholder":
		"Private Server Name (1-50 Characters)",
	"Label.ChangeServerStatusError": "Unable to change private server status.",
	"Label.ChangeServerStatusSuccess":
		"Successfully changed private server status.",
	"Label.ChangeSubscriptionStatusError":
		"Unable to change private server subscription status.",
	...
	"Label.PrivateServerSubscriptionMonthlyPaymentDue":
		"Your private server monthly payment is {value}",
	"Label.PrivateServerWillExpireDate":
		"Your private server will expire on {dateToExpire}",
	"Label.RemovePlayerBodyMessage":
		"Are you sure you want to remove {name} from your VIP Server? They will no longer be able to join your VIP Server.",
	...
	"Label.RenewPrivateServerBodyMessageConfirmation":
		"Are you sure you want to enable future payments for your private server of {name} by {creator}?",
	"Label.RenewPrivateServerBodyMessageStart":
		"This private server will start renewing every month at {date} until you cancel.",
	"Label.RenewVipServerBodyMessageConfirmation":
		"Are you sure you want to enable future payments for your VIP Server of {name} by {creator}?",
	"Label.RenewVipServerBodyMessageStart":
		"This VIP Server will start renewing every month at {date} until you cancel.",
	...
	"Label.SubscriptionMonthlyPaymentDue":
		"Your VIP Server monthly payment is {value}",
	...
	"Label.UpdateJoinGameLinkSuccess":
		"Successfully updated join experience link.",
	...
	"Message.CannotActivateCancelledServerError":
		"You cannot activate a cancelled private server.",
	"Message.CannotChangeWhitelistInactiveServer":
		"You may only add or remove users when your private server is active.",
	"Message.CannotConfigureCancelledServer":
		"You may not configure a cancelled private server. Please renew your subscription before configuring.",
	"Message.CannotManageGameError":
		"User does not have sufficient privileges to manage this experience.",
	"Message.ConfigurationFloodedError":
		"Please wait a few minutes before configuring your private server again.",
	"Message.CreatorDisabledPrivateServersError":
		"The creator of this experience has disabled private servers for this experience.",
	"Message.FriendOnlyGameError":
		"The experience must not be Friends Only to allow private servers.",
	"Message.IneligibleForVoiceChat": "You are not eligible for voice chat.",
	"Message.InsufficientFunds":
		"You do not have enough funds available to renew the subscription for this private server.",
	...
	"Message.InternalErrorPurchaseError":
	...
	"Message.InvalidServerNameError":
		"The name of the private server is either empty or too long.",
	"Message.InvalidServerOwnerError":
		"You are not the owner of this private server.",
	...
	"Message.InvalidUserInWhitelistError":
		"You may only add or remove valid users to your private server's invite list.",
	"Message.LoadPrivateServerError": "Unable to load private server information",
	"Message.MaxPlayersAdded":
		"You cannot add more than {maxPlayers} users to the private server's invite list.",
	"Message.NoSubscriptionChangeForFreeServer":
		"You cannot change the subscription status of a free private server.",
	...
	"Message.RecentPurchaseConfirmation":
		"You have recently purchased a private server for this experience. Are you sure you want to purchase another?",
	"Message.RenewPriceChangedError":
		"The price for renewing this private server has changed. Please refresh the page and try again.",
	"Message.ServerNotExistError": "That private server does not exist.",
	"Message.SubscriptionAlreadyActiveError":
		"The subscription to this private server is already active. There is no need to renew.",
	"Message.TooManyFreeServersOnGame":
		"You can not have more free private servers on this experience.",
	"Message.TooManyTotalActiveFreeServers":
		"You cannot have more active free private servers. Please deactivate some other servers first.",
	"Message.UnknownError": "Unknown error.",
	"Message.UserAlreadyInvited": "User is already invited to the private server",
	"Message.WhitelistCountExceeded":
		"You cannot add so many users to the private server's invite list.",
};
Roblox.Lang["VIPServerResources"] = Roblox.Lang["Feature.VIPServer"]; // ~/Generated/js/Roblox_TranslationResources_Feature_GameLaunchGuestModeResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
Roblox.Lang["Feature.GameLaunchGuestMode"] = {
	...
	"Description.Dialog.TrialOver":
		"Your trial period has ended. Please sign up to visit experiences - it's free!",
...
Roblox.Lang["GameLaunchGuestModeResources"] =
	Roblox.Lang["Feature.GameLaunchGuestMode"]; // ~/Generated/js/Roblox_TranslationResources_Feature_PromotedChannelsResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
Roblox.Lang["Feature.PromotedChannels"] = {
	...
	"Message.NoGroupPermission":
		"You do not have permission to configure this community.",
	...
	"Message.SocialLinksEditDisabledError":
		"Social links may not be edited at this time.",
	"Message.SocialLinkTypeLimitError":
		"Cannot have more than one {socialMediaType} social media links.",
	"Message.TitleEmptyError": "The title cannot be empty.",
	"Message.TitleModeratedError":
		"The title has been moderated, please try something else.",
	"Message.UnauthorizedError":
		"You do not have permission to update social links.",
	...
	"Message.UrlSocialMediaTypeMismatchError":
		"The url must match the social media type.",
};
Roblox.Lang["PromotedChannelsResources"] =
	Roblox.Lang["Feature.PromotedChannels"]; // ~/Generated/js/Roblox_TranslationResources_Feature_GameDetailsResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
Roblox.Lang["Feature.GameDetails"] = {
	...
	"Description.PlaceDescriptionDefault":
		"This is your very first Roblox creation. Check it out, then make it your own with Roblox Studio!",
	"Error.CopyLinkFailed":
		"Failed to copy link to clipboard. Please try again later.",
	...
	"Label.ContainsStrongLanguageWarningWithGuideline":
		"{guideline}, contains strong language",
...
Roblox.Lang["GameDetailsResources"] = Roblox.Lang["Feature.GameDetails"]; // ~/Generated/js/Roblox_TranslationResources_Feature_CommunityLinksResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
Roblox.Lang["Feature.CommunityLinks"] = {
	"Description.CommunityDefault":
		"Join the official Guilded community for {experienceName} to view announcements and more!",
	"Heading.CommunityTitle": "Join the community",
	"Label.ViewButton": "View",
};
Roblox.Lang["CommunityLinksResources"] = Roblox.Lang["Feature.CommunityLinks"]; // ~/Generated/js/Roblox_TranslationResources_Feature_SubscriptionResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
Roblox.Lang["Feature.Subscription"] = {
	...
	"Email.InsufficientBalance.Header":
		"Payment Issue: Insufficient Roblox Credit",
	"Email.InsufficientBalance.Subject":
		"Issue with your Subscription Renewal Payment",
	...
	"Email.LowBalanceWarning.Subject":
		"Your Subscription Renewal: Low Balance Warning",
	...
	"Heading.StripeFormAddPaymentMethodNote":
		"You have to add a payment method before subscribing",
	"Heading.Subscriptions": "Subscriptions",
	"Message.CannotPlayInExperience":
		"You can’t access content in this experience.",
	...
	"Message.ParentPermissionVPC":
		"To subscribe, your parent will need to help you add a payment method to your account.",
	"Message.ReportSubmitted":
		"Report submitted and will be reviewed by our team shortly.",
	...
	"Message.StripeEmailInputSubText":
		"Please provide an email you would like to use for this payment method. Once saved, the email cannot be changed.",
	"Message.SubscriptionNotAvailableExperienceOver17":
		"This experience is only available for users ages 17+",
	"Message.SubscriptionNotAvailableInCountry":
		"This subscription isn't available in your country at this time.",
	"Text.DisclaimerMonthly": "Renews monthly. Cancel anytime.",
	"Text.PerMonth": "/month",
	"Text.Subscribed": "Subscribed",
};
Roblox.Lang["SubscriptionResources"] = Roblox.Lang["Feature.Subscription"]; // ~/Generated/js/Roblox_TranslationResources_Common_GameSortsResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
Roblox.Lang["Common.GameSorts"] = {
	...
	"Label.LuobuWorkshop":
		"Luobu Workshop: outstanding creations from dev Creation Contest",
	...
	MegaHuntTooltip:
		"Complete quests in these experiences to earn badges and unlock prizes. Event ends March 30 at 12 PM PDT.",
	MegaHuntTooltipAprilAM:
		"Complete quests in these experiences to earn badges and unlock prizes. Event ends April {X} at {Y} AM PT.",
	MegaHuntTooltipAprilPM:
		"Complete quests in these experiences to earn badges and unlock prizes. Event ends April {X} at {Y} PM PT.",
	MegaHuntTooltipMarch30:
		"Complete quests in these experiences to earn badges and unlock prizes. Event ends March 30 at 12 PM PT.",
	MegaHuntTooltipMarchAM:
		"Complete quests in these experiences to earn badges and unlock prizes. Event ends March {X} at {Y} AM PT.",
	MegaHuntTooltipMarchPM:
		"Complete quests in these experiences to earn badges and unlock prizes. Event ends March {X} at {Y} PM PT.",
	MoreResultsFor: "More Results for",
};
Roblox.Lang["GameSortsResources"] = Roblox.Lang["Common.GameSorts"]; // ~/Generated/js/Roblox_TranslationResources_Feature_SocialShareResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
Roblox.Lang["Feature.SocialShare"] = {
	"Action.Share": "Share",
	"Description.ExperienceDoesNotExist": "This experience no longer exists.",
	"Description.InvalidLinkError": "This link doesn't exist.",
	"Description.InviteExpiredError":
		"The invite link has expired. Would you still like to join {experienceName}?",
	"Description.InviterNotHereError":
		"The inviter has left the experience. Would you still like to join {experienceName}?",
...
Roblox.Lang["SocialShareResources"] = Roblox.Lang["Feature.SocialShare"]; // ~/Generated/js/Roblox_TranslationResources_Feature_VirtualEventsResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
Roblox.Lang["Feature.VirtualEvents"] = {
	...
	FriendsInterestedTextMulti:
		"{username1}, {username2} and {number} friends or following",
...
Roblox.Lang["VirtualEventsResources"] = Roblox.Lang["Feature.VirtualEvents"]; // ~/Generated/js/Roblox_TranslationResources_Feature_GamePassResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
...
Roblox.Lang["GamePassResources"] = Roblox.Lang["Feature.GamePass"]; // ~/Generated/js/Roblox_TranslationResources_CommonUI_UserAgreementsResources_en_us_standard.js
var Roblox = Roblox || {};
Roblox.Lang = Roblox.Lang || {};
Roblox.Lang["CommonUI.UserAgreements"] = {
	"Modal.Agree": "I Agree",
	"Modal.Agreement.ChildrenPrivacyPolicy":
		"Privacy Protection Guidelines for Children",
...
Roblox.Lang["UserAgreementsResources"] = Roblox.Lang["CommonUI.UserAgreements"]; //Bundle detector

Roblox &&
	Roblox.BundleDetector &&
	Roblox.BundleDetector.bundleDetected("pageEnd");
